...
class CarController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return view('admin.cars.partials.table', compact('cars'))->render();
        }

        return view('admin.cars.index', compact('cars', 'search', 'status', 'totalCars', 'activeCars', 'inactiveCars', 'featuredCars'));
    }
        ...
        if ($softDeletedBrand) {
            ...
            if ($request->expectsJson()) {
                return response()->json([
                    ...
                    'redirect' => route('admin.cars.show', $softDeletedBrand),
                    'car' => $softDeletedBrand
                ]);
            }
            
            return redirect()->route('admin.cars.show', $softDeletedBrand)
    ...
    public function show(CarBrand $car)
    {
        ...
        return view('admin.cars.show', compact('car', 'carModels'));
    }
    ...
    public function update(Request $request, CarBrand $car)
    {
        ...
        if ($request->expectsJson()) {
            return response()->json([
                ...
                'redirect' => route('admin.cars.show', $car),
                'car' => $car
            ]);
        }
        
        return redirect()->route('admin.cars.show', $car)->with('success', 'Cập nhật hãng xe thành công!');
    }
    ...
    public function destroy(Request $request, CarBrand $car)
    {
        ...
        if ($ordersCount > 0) {
            ...
            return redirect()->route('admin.cars.index')->with('error', $message);
        }
        ...
        if ($modelsCount > 0) {
            ...
            return redirect()->route('admin.cars.index')->with('warning', $message)->with('confirm_delete', $car->id);
        }

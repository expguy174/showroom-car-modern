        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="pt-4 border-t border-gray-200 space-y-3">
                    ...
                    <div>
                                ...
                                <div class="flex items-center gap-2 px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="text-xs text-gray-600 mt-1">
                                            Đã thanh toán: <?php echo e($paidInstallments); ?>/<?php echo e($totalInstallments); ?> kỳ trước khi hủy
                                        </div>
                                    </div>
                                </div>
                            <?php elseif($order->payment_status == 'completed'): ?>
                        ...
                        <?php else: ?>
                            ...
                            <?php if($order->status == 'cancelled'): ?>
                                ...
                                <div class="flex items-center gap-2 px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg">
                                    <i class="fas fa-ban text-gray-600"></i>
                                    <span class="text-sm font-medium text-gray-800"><?php echo e($order->payment_status == 'cancelled' ? 'Đã hủy' : ucfirst($order->payment_status)); ?></span>
                    ...
                    <?php if(in_array($order->payment_status, ['partial', 'completed']) && $totalPaid > 0): ?>
                    <?php
                ...
                ?>
                <?php if($order->status != 'delivered' && $order->status != 'cancelled' && !$hasActiveRefund): ?>
                <div class="pt-4 border-t border-gray-200 space-y-2">
                    <?php if($order->status == 'pending'): ?>
                        <?php if(in_array($order->payment_status, ['partial', 'completed'])): ?>
                        ...
                        <?php elseif($order->finance_option_id && $order->down_payment_amount): ?>
                            ...
                            <div class="w-full space-y-2">
                                ...
                                <p class="text-xs text-amber-600 mt-2 text-center">
                                    <i class="fas fa-info-circle mr-1"></i>
                                    Vui lòng xác nhận tiền cọc <?php echo e(number_format($order->down_payment_amount)); ?> VNĐ trước
                                </p>
                            </div>
                        <?php else: ?>
                    ...
                    <?php if($canCancel): ?>
                    <form method="POST" action="<?php echo e(route('admin.orders.cancel', $order->id)); ?>" class="w-full" id="cancelOrderForm">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="w-full p-3 bg-gray-100 border border-gray-200 rounded-lg text-center">
                        <div class="text-sm text-gray-600">
                            ...
                            <?php echo e($cancelReason); ?>

                        </div>
                    </div>
                    <?php endif; ?>
                </div>
                <?php elseif($hasActiveRefund): ?>
                
                <div class="pt-4 border-t border-gray-200">
                    <?php if($hasPendingRefund): ?>
            ...
            <form method="POST" action="<?php echo e(route('admin.orders.refund', $order)); ?>" id="refundForm">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" 
                           id="refundAmount"
                           name="refund_amount" 
                           max="<?php echo e(number_format($totalPaid ?? $order->grand_total, 0, '.', '')); ?>"
                           value="<?php echo e(number_format($totalPaid ?? $order->grand_total, 0, '.', '')); ?>"
                           step="1000"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                    <div class="mt-1 space-y-1">
                        <p class="text-xs text-gray-500">
                            <span class="font-medium">Đã thanh toán:</span> <?php echo e(number_format($totalPaid ?? $order->grand_total, 0, ',', '.')); ?> VNĐ
                        </p>
                        ...
                        <?php endif; ?>
                        <p class="text-xs text-gray-500">
                            Tổng đơn hàng: <?php echo e(number_format($order->grand_total, 0, ',', '.')); ?> VNĐ
                        </p>
                    </div>
                </div>
...
document.getElementById('refundForm').addEventListener('submit', function(e) {
    ...
    const maxAmount = parseFloat('<?php echo e(number_format($totalPaid ?? $order->grand_total, 0, ".", "")); ?>');
...
<?php if($order->finance_option_id && $order->down_payment_amount && $order->payment_status === 'pending'): ?>
            ...
            <div class="p-6">
                ...
                <div class="mb-4 p-4 bg-blue-50 rounded-lg">
                    <p class="text-sm text-blue-800">
                        <strong>Số tiền cọc:</strong> <?php echo e(number_format($order->down_payment_amount)); ?> VNĐ
                    </p>
                ...
                <form id="downPaymentForm" method="POST" action="<?php echo e(route('admin.orders.confirm-down-payment', $order->id)); ?>" onsubmit="handleDownPaymentSubmit(event)">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                            ...
                            <select name="payment_method_id" required class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                ...
                                <?php $__currentLoopData = $manualPaymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($method->id); ?>"><?php echo e($method->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="payment_date" required value="<?php echo e(date('Y-m-d')); ?>"
    ...
    <div class="bg-white rounded-xl shadow-2xl max-w-md w-full transform transition-all duration-200">
        <div class="p-6">
            ...
            <p class="text-gray-600 text-center mb-4">
                Bạn có chắc chắn muốn hủy đơn hàng <strong>#<?php echo e($order->order_number ?? $order->id); ?></strong>?
            </p>
            <p class="text-sm text-gray-500 text-center mb-6">
                Giá trị: <strong><?php echo e(number_format($order->grand_total, 0, ',', '.')); ?> VNĐ</strong>
                <?php if($order->finance_option_id): ?>

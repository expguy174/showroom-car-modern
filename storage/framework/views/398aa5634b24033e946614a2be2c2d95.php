...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.stock-badge','data' => ['stock' => $accessory->stock_quantity ?? 0,'type' => 'accessory','size' => 'sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['stock' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($accessory->stock_quantity ?? 0),'type' => 'accessory','size' => 'sm']); ?>

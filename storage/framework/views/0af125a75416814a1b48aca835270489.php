<?php $__env->startSection('title', 'Chỉnh sửa đại lý: ' . $dealership->name); ?>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 max-w-7xl mx-auto">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-xl font-semibold text-gray-900">
                    ...
                    Chỉnh sửa đại lý: <?php echo e($dealership->name); ?>

                </h1>
                <p class="text-sm text-gray-600 mt-1">Cập nhật thông tin đại lý</p>
            </div>
            <a href="<?php echo e(route('admin.dealerships.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white text-sm font-medium rounded-lg transition-colors">
    ...
    <form id="dealershipForm" action="<?php echo e(route('admin.dealerships.update', $dealership)); ?>" method="POST" class="p-6">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                value="<?php echo e(old('name', $dealership->name)); ?>"
                        ...
                        <div>
                            ...
                            <input type="text" name="code" id="code"
                                class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="<?php echo e(old('code', $dealership->code)); ?>"
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4"
                                class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Nhập mô tả về đại lý..."><?php echo e(old('description', $dealership->description)); ?></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" id="phone"
                                class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="<?php echo e(old('phone', $dealership->phone)); ?>"
                        ...
                        <div>
                            ...
                            <input type="text" name="email" id="email"
                                class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="<?php echo e(old('email', $dealership->email)); ?>"
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="address" id="address"
                                class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="<?php echo e(old('address', $dealership->address)); ?>"
                        ...
                        <div>
                            ...
                            <input type="text" name="city" id="city"
                                class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="<?php echo e(old('city', $dealership->city)); ?>"
                        ...
                        <div>
                            ...
                            <input type="text" name="country" id="country"
                                class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="<?php echo e(old('country', $dealership->country)); ?>"
                                placeholder="Vietnam">
                        </div>
                        ...
                        <div>
                            <label class="flex items-center">
                                ...
                                <input type="checkbox" name="is_active" value="1"
                                    ...
                                    <?php echo e(old('is_active', $dealership->is_active) ? 'checked' : ''); ?>>
        ...
        <div class="flex items-center justify-between pt-6 mt-6 border-t border-gray-200">
            <a href="<?php echo e(route('admin.dealerships.index')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
    ...
    document.getElementById('dealershipForm').addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Redirect
                setTimeout(() => {
                    window.location.href = '<?php echo e(route("admin.dealerships.index")); ?>';
                }, 1500);
            } else {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\forev\showroom-car-modern\resources\views/admin/dealerships/edit.blade.php ENDPATH**/ ?>
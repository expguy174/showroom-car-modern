<?php $__env->startSection('title', $accessory->name . ' - AutoLux'); ?>
                ...
                <ol class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="<?php echo e(route('products.index', ['type' => 'accessory'])); ?>" class="text-gray-500 hover:text-blue-600 transition-colors">Phụ kiện</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                            <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                            <span class="text-gray-900 font-medium"><?php echo e($accessory->name); ?></span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-8">
            ...
            <div class="space-y-3 lg:space-y-5 lg:col-span-5">
                ...
                <div class="relative group">
                    <div class="aspect-[3/2] bg-white rounded-3xl shadow-2xl overflow-hidden">
                        <img src="<?php echo e($mainImage); ?>"
                             ...
                             data-lightbox-src="<?php echo e($mainImage); ?>">
                    </div>
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between text-sm font-semibold text-gray-700 mt-1">
                        <div class="flex items-center">
                            <i class="fas fa-images mr-2"></i>Thư viện ảnh (<?php echo e(count($gallery)); ?>)
                        </div>
                    ...
                    <div id="accessory-thumbs" class="relative overflow-hidden">
                        ...
                        ?>
                        <div class="flex transition-transform duration-500 ease-in-out thumbnails-slider" data-slide-index="0" data-total-pages="<?php echo e($totalPages); ?>">
                            <?php $__currentLoopData = $chunkedGallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pageIndex => $pageImages): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="w-full flex-shrink-0">
                                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 px-1">
                                    ...
                                    <?php $thumb = $resolveImage($image, $accessory->name ?? ''); ?>
                                    <div class="aspect-square w-full bg-white rounded-2xl shadow-lg overflow-hidden cursor-pointer hover:shadow-xl transition-all duration-300 thumbnail-image" 
                                                 data-image="<?php echo e($thumb); ?>" data-lightbox-src="<?php echo e($thumb); ?>">
                                        <img src="<?php echo e($thumb); ?>" alt="<?php echo e($accessory->name); ?>" class="w-full h-full object-cover hover:scale-110 transition-transform duration-300" loading="lazy" decoding="async" width="300" height="300">
                    </div>
            ...
            <div class="space-y-4 lg:space-y-6 lg:col-span-7 mt-4 lg:mt-0">
                <!-- Header -->
                <div class="space-y-4">
                    <?php if($accessory->brand): ?>
                    <div class="flex items-center gap-2">
                    <div class="inline-flex items-center bg-blue-50 text-blue-700 px-4 py-2 rounded-full text-sm font-semibold">
                        <i class="fas fa-crown mr-2"></i>
                        <?php echo e($accessory->brand); ?>

                        </div>
                        <?php if($accessory->category): ?>
                        <span class="text-gray-300">|</span>
                        <a href="<?php echo e(route('products.index', ['type' => 'accessory', 'acc_category' => $accessory->category])); ?>" class="text-sm text-gray-700 hover:text-gray-900 hover:underline"><?php echo e($accessory->category); ?></a>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                    
                    <h1 class="text-4xl lg:text-5xl font-black text-gray-900 leading-tight"><?php echo e($accessory->name); ?></h1>
                    
                    <?php if($accessory->short_description): ?>
                    <p class="text-xl text-gray-600 leading-relaxed"><?php echo e($accessory->short_description); ?></p>
                    <?php endif; ?>
                    
                    <!-- Rating -->
                    <?php $avgInline = $accessory->approved_reviews_avg ?? 0; $accCount = $accessory->approved_reviews_count ?? $accessory->reviews()->where('is_approved', true)->count(); ?>
                    <div id="rating-summary-inline" class="flex items-center space-x-4 <?php echo e(($avgInline>0?'':'hidden')); ?>">
                        <div class="flex items-center space-x-1" id="rating-stars-inline" data-avg="<?php echo e((float)$avgInline); ?>">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <?php if($i <= $avgInline): ?>
                        ...
                        <span class="text-gray-500 <?php echo e(($accCount>0?'':'hidden')); ?>">(<span id="rating-count-inline"><?php echo e(number_format($accCount ?? 0)); ?></span> đánh giá)</span>
                    </div>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.stock-badge','data' => ['stock' => $accessory->stock_quantity ?? 0,'type' => 'accessory','size' => 'md']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['stock' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($accessory->stock_quantity ?? 0),'type' => 'accessory','size' => 'md']); ?>
...
<?php endif; ?>
                ...
                <div class="mt-3 grid grid-cols-2 gap-2">
                    ...
                    ?>
                        <button type="button" class="action-btn action-ghost w-full js-wishlist-toggle <?php echo e($__inWishlistAccPage ? 'in-wishlist' : 'not-in-wishlist'); ?>" aria-label="Yêu thích" title="Yêu thích" aria-pressed="<?php echo e($__inWishlistAccPage ? 'true' : 'false'); ?>" data-item-type="accessory" data-item-id="<?php echo e($accessory->id); ?>">
                        <i class="fa-heart <?php echo e($__inWishlistAccPage ? 'fas' : 'far'); ?>"></i><span>Yêu thích</span>
                        </button>
                        <form action="<?php echo e(route('user.cart.add')); ?>" method="POST" class="w-full add-to-cart-form" data-item-type="accessory" data-item-id="<?php echo e($accessory->id); ?>">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="item_type" value="accessory">
                            <input type="hidden" name="item_id" value="<?php echo e($accessory->id); ?>">
                            <input type="hidden" name="quantity" value="1">
                            <button type="submit" class="action-btn action-primary w-full" 
                                <?php if(($accessory->stock_quantity ?? 0) <= 0): ?> disabled <?php endif; ?>>
                                <i class="fas fa-cart-plus"></i>
                                <span><?php echo e(($accessory->stock_quantity ?? 0) > 0 ? 'Thêm vào giỏ' : 'Hết hàng'); ?></span>
                            </button>
                        </form>
                    </div>
                    <?php endif; ?>
            ...
            <div class="py-12">
                    ...
                    <div class="prose prose-lg max-w-none">
                        <div class="bg-white rounded-3xl shadow-xl p-8">
                            ...
                            <div class="text-gray-700 leading-relaxed">
                                <?php echo nl2br(e($accessory->description ?? 'Chưa có mô tả chi tiết cho sản phẩm này.')); ?>

                            </div>
                            
                            <?php if($accessory->features): ?>
                            <div class="mt-8">
                                <h4 class="text-xl font-semibold text-gray-900 mb-4">Tính năng nổi bật</h4>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <?php $__currentLoopData = json_decode($accessory->features, true) ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center space-x-3 bg-gray-50 rounded-xl p-4">
                                        <i class="fas fa-check-circle text-green-500 text-lg"></i>
                                        <span class="font-medium text-gray-900"><?php echo e($feature); ?>: <?php echo e($value); ?></span>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-3xl shadow-xl p-8">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <div class="space-y-6">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                        ...
                                        <span class="font-semibold text-gray-900">
                                            <?php switch($accessory->subcategory):
                                                case ('camera'): ?>
                                                    Camera
                                                    <?php break; ?>
                                                <?php case ('dash_cam'): ?>
                                                ...
                                                <?php case ('sensor'): ?>
                                                    ...
                                                    <?php break; ?>
                                                <?php default: ?>
                                                    <?php echo e($accessory->subcategory); ?>
                                    ...
                                    <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                        ...
                                        <span class="font-semibold text-gray-900"><?php echo e($accessory->brand); ?></span>
                                    </div>
                                    <?php endif; ?>
                                    <?php if($accessory->model): ?>
                                    <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                        <span class="text-gray-600 font-medium">Model:</span>
                                        <span class="font-semibold text-gray-900"><?php echo e($accessory->model); ?></span>
                                    </div>
                                    <?php endif; ?>
                                    <?php if($accessory->sku): ?>
                                    <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                        <span class="text-gray-600 font-medium">SKU:</span>
                                        <span class="font-semibold text-gray-900 font-mono"><?php echo e($accessory->sku); ?></span>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="space-y-4">
                                    <?php if($accessory->weight): ?>
                                    <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                        <span class="text-gray-600 font-medium">Trọng lượng:</span>
                                        <span class="font-semibold text-gray-900"><?php echo e($accessory->weight); ?> kg</span>
                                    </div>
                                    <?php endif; ?>
                                    <?php if($accessory->dimensions): ?>
                                    <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                        <span class="text-gray-600 font-medium">Kích thước:</span>
                                        <span class="font-semibold text-gray-900"><?php echo e($accessory->dimensions); ?></span>
                                    </div>
                                    <?php endif; ?>
                                    <?php if($accessory->material): ?>
                                    <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                        <span class="text-gray-600 font-medium">Chất liệu:</span>
                                        <span class="font-semibold text-gray-900"><?php echo e($accessory->material); ?></span>
                                    </div>
                                    <?php endif; ?>
                                    <?php if($accessory->warranty_months): ?>
                                    <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                        <span class="text-gray-600 font-medium">Bảo hành:</span>
                                        <span class="font-semibold text-gray-900"><?php echo e($accessory->warranty_months); ?> tháng</span>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <?php if($accessory->specifications): ?>
                        <div class="mt-8">
                            <h4 class="text-xl font-semibold text-gray-900 mb-4">Thông số chi tiết</h4>
                            <div class="bg-gray-50 rounded-2xl p-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    <?php $__currentLoopData = json_decode($accessory->specifications, true) ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spec => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="bg-white rounded-xl p-4 shadow-sm">
                                        <div class="text-sm text-gray-500 font-medium mb-1"><?php echo e($spec); ?></div>
                                        <div class="text-lg font-semibold text-gray-900"><?php echo e($value); ?></div>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                ...
                <div id="compatibility" class="tab-content hidden">
                    <div class="bg-white rounded-3xl shadow-xl p-8">
                        ...
                        <?php if($accessory->compatible_car_brands || $accessory->compatible_car_models): ?>
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <?php if($accessory->compatible_car_brands): ?>
                            <div>
                                <h4 class="text-xl font-semibold text-gray-900 mb-4">Thương hiệu tương thích</h4>
                                <div class="space-y-3">
                                    <?php $__currentLoopData = json_decode($accessory->compatible_car_brands, true) ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center space-x-3 bg-blue-50 rounded-xl p-4">
                                        <i class="fas fa-car text-blue-500"></i>
                                        <span class="font-medium text-gray-900"><?php echo e($brand); ?></span>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                            ...
                            <?php if($accessory->compatible_car_models): ?>
                            <div>
                                <h4 class="text-xl font-semibold text-gray-900 mb-4">Model tương thích</h4>
                                <div class="space-y-3">
                                    <?php $__currentLoopData = json_decode($accessory->compatible_car_models, true) ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center space-x-3 bg-green-50 rounded-xl p-4">
                                        <i class="fas fa-car-side text-green-500"></i>
                                        <span class="font-medium text-gray-900"><?php echo e($model); ?></span>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                        ...
                        <div class="mt-8 bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-6 border border-green-200">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-green-600 font-semibold mt-2">Phí lắp đặt: <?php echo e(number_format($accessory->installation_fee, 0, ',', '.')); ?>₫</p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="reviews-summary" class="mb-8">
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                <div class="lg:col-span-1 text-center bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100">
                                    <?php $avgRating = $accessory->approved_reviews_avg ?? 0; ?>
                                    ...
                                    <?php $approvedCount2 = $accessory->approved_reviews_count ?? $accessory->reviews()->where('is_approved', true)->count(); ?>
                        ...
                        <div id="review-modal" class="fixed inset-0 z-[10000] bg-black/60 hidden" style="display:none; align-items:center; justify-content:center;" role="dialog" aria-modal="true" aria-labelledby="review-modal-title">
                            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-5 relative">
                                ...
                                <form id="review-form" class="space-y-3">
                                    ...
                                    <input type="hidden" name="reviewable_id" value="<?php echo e($accessory->id); ?>">
                                    <div>
        ...
        <!-- Related Products -->
        <?php if(isset($relatedAccessories) && $relatedAccessories->count() > 0): ?>
        <div class="mt-20 pb-20">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <?php $__currentLoopData = $relatedAccessories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo $__env->make('components.accessory-card', ['accessory' => $related], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        <?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    (function initAccessoryReviews(){
        ...
        let currentPage = 1;
        const accessoryId = Number('<?php echo e($accessory->id); ?>');
        ...
        function updateInlineSummary(){
            fetch(`<?php echo e(route('reviews.summary')); ?>?reviewable_type=${type}&reviewable_id=${accessoryId}`,{headers:{'X-Requested-With':'XMLHttpRequest'}})
        ...
        function load(page){
            fetch(`<?php echo e(route('reviews.get')); ?>?reviewable_type=${type}&reviewable_id=${accessoryId}&page=${page}`,{headers:{'X-Requested-With':'XMLHttpRequest'}})
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\forev\showroom-car-modern\resources\views/user/accessories/show.blade.php ENDPATH**/ ?>
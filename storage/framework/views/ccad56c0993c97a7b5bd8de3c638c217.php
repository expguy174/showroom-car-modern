...
<form id="<?php echo e($formId ?? 'filter-form'); ?>" method="GET" action="<?php echo e(route($routeName ?? 'products.index')); ?>" class="inventory-filter-form space-y-5">
    <?php if(request('debug') === 'options'): ?>
    <details class="mb-3 text-xs text-gray-600 bg-gray-50 border border-gray-200 rounded p-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-2 mt-2">
            <div>
                ...
                <pre class="whitespace-pre-wrap"><?php echo json_encode($fuelOptions ?? [], 15, 512) ?></pre>
            </div>
            <div>
                <div class="font-medium">Transmission options</div>
                <pre class="whitespace-pre-wrap"><?php echo json_encode($transOptions ?? [], 15, 512) ?></pre>
            </div>
            <div>
                <div class="font-medium">Body options</div>
                <pre class="whitespace-pre-wrap"><?php echo json_encode($bodyOptions ?? [], 15, 512) ?></pre>
            </div>
        </div>
    </details>
    <?php endif; ?>
    <div>
        ...
        <div class="inline-flex items-center gap-1 p-1 rounded-lg bg-gray-100" role="tablist" aria-label="Bộ lọc loại">
            ...
            <button type="button" class="js-type-tab px-3 py-1.5 rounded-md text-sm <?php echo e($currentType==='all' ? 'bg-white text-gray-900 shadow' : 'text-gray-600 hover:text-gray-900'); ?>" data-value="all" role="tab" aria-selected="<?php echo e($currentType==='all' ? 'true' : 'false'); ?>">Tất cả</button>
            <button type="button" class="js-type-tab px-3 py-1.5 rounded-md text-sm <?php echo e($currentType==='car' ? 'bg-white text-gray-900 shadow' : 'text-gray-600 hover:text-gray-900'); ?>" data-value="car" role="tab" aria-selected="<?php echo e($currentType==='car' ? 'true' : 'false'); ?>">Xe hơi</button>
            <button type="button" class="js-type-tab px-3 py-1.5 rounded-md text-sm <?php echo e($currentType==='accessory' ? 'bg-white text-gray-900 shadow' : 'text-gray-600 hover:text-gray-900'); ?>" data-value="accessory" role="tab" aria-selected="<?php echo e($currentType==='accessory' ? 'true' : 'false'); ?>">Phụ kiện</button>
        </div>
    ...
    <div class="space-y-5">
        <?php ($currentType = request('type','all')); ?>
        <!-- Car panel -->
        <div class="filter-panel <?php echo e($currentType==='car' ? '' : 'hidden'); ?>" data-panel="car">
            <div>
                ...
                <select name="brand" class="w-full border-gray-200 rounded-lg text-sm">
                    ...
                    <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($b->id); ?>" <?php echo e((string)request('brand') === (string)$b->id ? 'selected' : ''); ?>><?php echo e($b->name); ?></option>
            ...
            <div>
                ...
                <select name="model" class="w-full border-gray-200 rounded-lg text-sm">
                    ...
                    <?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($m->id); ?>" <?php echo e((string)request('model') === (string)$m->id ? 'selected' : ''); ?>><?php echo e($m->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="grid grid-cols-2 gap-3">
                <div>
                    ...
                    <select name="fuel_type" class="w-full border-gray-200 rounded-lg text-sm">
                        <option value="">Tất cả</option>
                        <?php $__currentLoopData = $fuelList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($opt['value']); ?>" <?php echo e(request('fuel_type')===$opt['value'] ? 'selected' : ''); ?>><?php echo e($opt['label']); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    ...
                    <select name="transmission" class="w-full border-gray-200 rounded-lg text-sm">
                        <option value="">Tất cả</option>
                        <?php $__currentLoopData = $transList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($opt['value']); ?>" <?php echo e(request('transmission')===$opt['value'] ? 'selected' : ''); ?>><?php echo e($opt['label']); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="col-span-2">
                    ...
                    <select name="body_type" class="w-full border-gray-200 rounded-lg text-sm">
                        <option value="">Tất cả</option>
                        <?php $__currentLoopData = $bodyList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($opt['value']); ?>" <?php echo e(request('body_type')===$opt['value'] ? 'selected' : ''); ?>><?php echo e($opt['label']); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
            <div class="mt-4">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <input type="number" inputmode="numeric" name="price_min" value="<?php echo e(request('price_min')); ?>" placeholder="Tối thiểu" class="border-gray-200 rounded-lg text-sm" />
                    <input type="number" inputmode="numeric" name="price_max" value="<?php echo e(request('price_max')); ?>" placeholder="Tối đa" class="border-gray-200 rounded-lg text-sm" />
                </div>
        ...
        <!-- Accessory panel -->
        <div class="filter-panel <?php echo e($currentType==='accessory' ? '' : 'hidden'); ?>" data-panel="accessory">
            <div class="grid grid-cols-1 gap-3">
                <div>
                    ...
                    <select name="acc_category" class="w-full border-gray-200 rounded-lg text-sm">
                        <option value="">Tất cả</option>
                        <?php $__currentLoopData = ($accessoryCategories ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php ($catKey = is_scalar($cat) ? strtolower(trim((string)$cat)) : ''); ?>
                            <?php ($catLabel = $accCatVi[$catKey] ?? (string)$cat); ?>
                            <option value="<?php echo e($cat); ?>" <?php echo e(request('acc_category')===$cat ? 'selected' : ''); ?>><?php echo e($catLabel); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    ...
                    <select name="stock_status" class="w-full border-gray-200 rounded-lg text-sm">
                        ...
                        <option value="discontinued" <?php echo e(request('stock_status')==='discontinued' ? 'selected' : ''); ?>>Ngừng bán</option>
                    </select>
                </div>
            </div>
            <div class="mt-4">
        ...
        <!-- All panel (minimal) -->
        <div class="filter-panel <?php echo e($currentType==='all' ? '' : 'hidden'); ?>" data-panel="all">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Khoảng giá (VNĐ)</label>
                <div class="grid grid-cols-2 gap-2">
                    <input type="number" inputmode="numeric" name="price_min" value="<?php echo e(request('price_min')); ?>" placeholder="Tối thiểu" class="border-gray-200 rounded-lg text-sm" />
...
<?php /**PATH C:\Users\forev\showroom-car-modern\resources\views/user/products/partials/filters.blade.php ENDPATH**/ ?>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-semibold mr-3">
                                    <?php echo e(substr($order->order_number ?? $order->id, -2)); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">
                                <div class="font-medium"><?php echo e(optional($order->user->userProfile)->name ?? 'Khách vãng lai'); ?></div>
                                <div class="text-gray-500"><?php echo e(optional($order->user)->email ?? '-'); ?></div>

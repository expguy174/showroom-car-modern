...
<body class="font-sans antialiased bg-gray-50">
        ...
        <div id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 transform -translate-x-full transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:inset-0 md:flex md:flex-col">
            ...
            <nav class="flex-1 overflow-y-auto p-4 space-y-1">
                ...
                <div>
                    ...
                    <a href="<?php echo e(route('admin.reviews.index')); ?>" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('admin.reviews.*') ? 'bg-blue-100 text-blue-700 border-r-2 border-blue-500' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'); ?>">
                        <i class="fas fa-star mr-3 w-4 text-center <?php echo e(request()->routeIs('admin.reviews.*') ? 'text-blue-600' : 'text-gray-500'); ?>"></i>
                        <span>Đánh giá</span>
                    </a>
                </div>
                ...
                <div class="pt-6">
                    ...
                    <?php if(in_array($role, ['admin', 'manager'])): ?>
                    <a href="<?php echo e(route('admin.installments.index')); ?>" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('admin.installments.*') ? 'bg-blue-100 text-blue-700 border-r-2 border-blue-500' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'); ?>">
                        <i class="fas fa-calendar-check mr-3 w-4 text-center <?php echo e(request()->routeIs('admin.installments.*') ? 'text-blue-600' : 'text-gray-500'); ?>"></i>
                        <span>Lịch trả góp</span>
                    </a>
                    
                    <a href="<?php echo e(route('admin.finance-options.index')); ?>" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('admin.finance-options.*') ? 'bg-blue-100 text-blue-700 border-r-2 border-blue-500' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'); ?>">
                        <i class="fas fa-calculator mr-3 w-4 text-center <?php echo e(request()->routeIs('admin.finance-options.*') ? 'text-blue-600' : 'text-gray-500'); ?>"></i>
                    ...
                    <?php if(in_array($role, ['admin', 'manager'])): ?>
                    <a href="<?php echo e(route('admin.payment-methods.index')); ?>" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('admin.payment-methods.*') ? 'bg-blue-100 text-blue-700 border-r-2 border-blue-500' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'); ?>">
                        <i class="fas fa-credit-card mr-3 w-4 text-center <?php echo e(request()->routeIs('admin.payment-methods.*') ? 'text-blue-600' : 'text-gray-500'); ?>"></i>
                        <span>Phương thức TT</span>
                    </a>
                    
                    <a href="<?php echo e(route('admin.payments.refunds')); ?>" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('admin.payments.refunds*') ? 'bg-blue-100 text-blue-700 border-r-2 border-blue-500' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'); ?>">
                        <i class="fas fa-undo mr-3 w-4 text-center <?php echo e(request()->routeIs('admin.payments.refunds*') ? 'text-blue-600' : 'text-gray-500'); ?>"></i>
                        <span>Hoàn tiền</span>
                    </a>
                    <?php endif; ?>
                </div>
                ...
                <div class="pt-6">
                    ...
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('admin.users.*') ? 'bg-blue-100 text-blue-700 border-r-2 border-blue-500' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'); ?>">
                        <i class="fas fa-user-circle mr-3 w-4 text-center <?php echo e(request()->routeIs('admin.users.*') ? 'text-blue-600' : 'text-gray-500'); ?>"></i>
                        <span>Người dùng</span>
                    </a>
                    
                    <a href="<?php echo e(route('admin.contact-messages.index')); ?>" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors <?php echo e(request()->routeIs('admin.contact-messages.*') ? 'bg-blue-100 text-blue-700 border-r-2 border-blue-500' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'); ?>">
                        <i class="fas fa-envelope mr-3 w-4 text-center <?php echo e(request()->routeIs('admin.contact-messages.*') ? 'text-blue-600' : 'text-gray-500'); ?>"></i>
                        <span>Liên hệ</span>
                    </a>
                </div>
                <?php endif; ?>
            ...
            <div class="flex-shrink-0 p-4 border-t border-gray-200 bg-white">
                <a href="<?php echo e(route('home')); ?>" onclick="clearCacheAndNavigate(event)" class="flex items-center px-3 py-2 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100 mb-2">
                                ...
                                <button id="notifications-button" class="relative p-2 text-gray-400 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-lg">
                                    ...
                                    <?php
                                        ...
                                        $unreadCount = \App\Models\Notification::whereNull('user_id')
                                            ...
                                            ->count();
                                    ?>
                                    <span id="notification-badge" class="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center <?php echo e($unreadCount > 0 ? '' : 'hidden'); ?>">
    ...
    <script>
        ...
        function clearCacheAndNavigate(event) {
            ...
            const url = '<?php echo e(route("home")); ?>?_nocache=' + Date.now();
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.showDeleteNotificationModal = function(id, event) {
                ...
                fetch(`<?php echo e(route("admin.notifications.destroy", ":id")); ?>`.replace(':id', id), {
                    method: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                        'X-Requested-With': 'XMLHttpRequest',
            ...
            if (notificationsButton && notificationsDropdown) {
                ...
                if (deleteAllNotificationsButton) {
                    deleteAllNotificationsButton.addEventListener('click', function(e) {
                        ...
                        fetch('<?php echo e(route("admin.notifications.delete-all")); ?>', {
                            method: 'DELETE',
                            headers: {
                                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                                'X-Requested-With': 'XMLHttpRequest',

<?php $__env->startSection('title', $variant->name . ' - AutoLux'); ?>
...
?>
<link rel="preload" as="image" href="<?php echo e($mainImage); ?>">
<script type="application/ld+json"><?php echo json_encode($productJson, JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES); ?></script>
<?php $__env->stopPush(); ?>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-4">
                    <li>
                        <a href="<?php echo e(route('home')); ?>" class="text-gray-400 hover:text-blue-600 transition-colors">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="<?php echo e(route('car-brands.show', optional(optional($variant->carModel)->carBrand)->id ?? 1)); ?>" class="text-gray-500 hover:text-blue-600 transition-colors"><?php echo e(optional(optional($variant->carModel)->carBrand)->name ?? 'Xe hơi'); ?></a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                            <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                            <a href="<?php echo e(route('car-models.show', optional($variant->carModel)->id ?? 1)); ?>" class="text-gray-500 hover:text-blue-600 transition-colors"><?php echo e(optional($variant->carModel)->name ?? 'Model'); ?></a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                            <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                            <span class="text-gray-900 font-medium"><?php echo e($variant->name); ?></span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-8">
            ...
            <div class="space-y-3 lg:space-y-5 lg:col-span-5">
                    ...
                    <div class="aspect-[3/2] bg-gradient-to-br from-gray-100 to-gray-200 rounded-3xl shadow-2xl overflow-hidden">
                        ...
                        <img src="<?php echo e($main); ?>"
                         id="main-image"
                             ...
                             data-lightbox-src="<?php echo e($main); ?>">
                    </div>
                ...
                ?>
                <div class="space-y-4">
                    <?php $__currentLoopData = $thumbBlocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typeKey => $collection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="flex items-center justify-between text-sm font-semibold text-gray-700 mt-1">
                            <div class="flex items-center">
                                <i class="fas fa-images mr-2"></i><?php echo e($thumbLabels[$typeKey] ?? Str::ucfirst($typeKey)); ?> (<?php echo e($collection->count()); ?>)
                            </div>
                            <?php if($totalPages > 1): ?>
                            <div class="flex items-center gap-2">
                                <button type="button" class="w-8 h-8 rounded-full bg-white shadow-sm hover:shadow-md border border-gray-200 flex items-center justify-center text-gray-500 hover:text-gray-700 transition-all duration-200 slide-prev-variant" data-target="variant-thumbs-<?php echo e($typeKey); ?>">
                                    <i class="fas fa-chevron-left text-xs"></i>
                                </button>
                                <button type="button" class="w-8 h-8 rounded-full bg-white shadow-sm hover:shadow-md border border-gray-200 flex items-center justify-center text-gray-500 hover:text-gray-700 transition-all duration-200 slide-next-variant" data-target="variant-thumbs-<?php echo e($typeKey); ?>">
                        ...
                        <div class="relative">
                            ...
                            <!-- Slider Container -->
                            <div id="variant-thumbs-<?php echo e($typeKey); ?>" class="relative overflow-hidden rounded-2xl">
                                <div class="thumbnails-slider-variant flex transition-transform duration-500 ease-in-out" data-current-page="0" data-total-pages="<?php echo e($totalPages); ?>">
                                    <?php $__currentLoopData = $chunkedImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pageIndex => $pageImages): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="w-full flex-shrink-0">
                                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 px-1">
                                            <?php $__currentLoopData = $pageImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php $thumb = $resolveImage($image['image_url'], $variant->name ?? ''); ?>
                                            <div class="aspect-square w-full bg-white rounded-2xl shadow-lg overflow-hidden cursor-pointer hover:shadow-xl transition-all duration-300 thumbnail-image group" 
                                                 data-image="<?php echo e($thumb); ?>" data-lightbox-src="<?php echo e($thumb); ?>" data-type="<?php echo e($typeKey); ?>" data-color-id="<?php echo e((int)($image['car_variant_color_id'] ?? 0)); ?>" data-is-main="<?php echo e($image['is_main'] ? '1' : '0'); ?>">
                                                <img src="<?php echo e($thumb); ?>" alt="<?php echo e($variant->name); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" loading="lazy" decoding="async" width="300" height="300">
                                            </div>
            ...
            <div class="space-y-4 lg:space-y-6 lg:col-span-7 mt-4 lg:mt-0">
                <!-- Header -->
                <div class="space-y-4">
                    <?php if(optional($variant->carModel)->carBrand): ?>
                    <div class="flex items-center gap-2">
                    <div class="inline-flex items-center bg-blue-50 text-blue-700 px-4 py-2 rounded-full text-sm font-semibold">
                        <i class="fas fa-crown mr-2"></i>
                        <?php echo e(optional(optional($variant->carModel)->carBrand)->name); ?>

                        </div>
                        <a href="<?php echo e(route('car-brands.show', optional(optional($variant->carModel)->carBrand)->id ?? 1)); ?>" class="text-sm text-blue-600 hover:text-blue-800 hover:underline">Xem hãng</a>
                        <span class="text-gray-300">|</span>
                        <a href="<?php echo e(route('car-models.show', optional($variant->carModel)->id ?? 1)); ?>" class="text-sm text-gray-700 hover:text-gray-900 hover:underline">Xem dòng</a>
                    </div>
                    <?php endif; ?>
                    
                    <h1 class="text-4xl lg:text-5xl font-black text-gray-900 leading-tight"><?php echo e($variant->name); ?></h1>
                    
                    <?php if(optional($variant->carModel)->name): ?>
                    <p class="text-xl text-gray-600 leading-relaxed"><?php echo e(optional($variant->carModel)->name); ?></p>
                    <?php endif; ?>
                    <?php if(!empty($variant->short_description)): ?>
                    <p class="text-base text-gray-600 leading-relaxed"><?php echo e($variant->short_description); ?></p>
                    <?php endif; ?>
                    <?php 
                    ...
                    <!-- Rating -->
                    <?php $avgInline = isset($approvedAvg) ? $approvedAvg : ($variant->approved_reviews_avg ?? 0); ?>
                    <div id="rating-summary-inline" class="flex items-center space-x-4 <?php echo e(($avgInline>0?'':'hidden')); ?>">
                        <div id="rating-stars-inline" class="flex items-center space-x-1" data-avg="<?php echo e((float)$avgInline); ?>">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <?php if($i <= $avgInline): ?>
                                    <i class="fas fa-star text-yellow-400 text-lg"></i>
                                <?php elseif($i - $avgInline < 1): ?>
                        ...
                        <span class="text-lg font-semibold text-gray-900"><span id="rating-avg-inline"><?php echo e(number_format((float)$avgInline, 1)); ?></span></span>
                        <?php $approvedCount = isset($approvedCount) ? $approvedCount : ($variant->approved_reviews_count ?? $variant->approvedReviews()->count()); ?>
                        <span class="text-gray-500 <?php echo e((($approvedCount ?? 0)>0?'':'hidden')); ?>">(<span id="rating-count-inline"><?php echo e(number_format($approvedCount ?? 0)); ?></span> đánh giá)</span>
                ...
                <div class="space-y-3">
                    ...
                    <div class="grid grid-cols-3 sm:grid-cols-4 gap-2">
                        <?php $__currentLoopData = $variant->colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <button type="button"
                                class="color-option flex flex-col items-center p-2.5 border border-gray-200 rounded-xl hover:border-blue-500 hover:bg-blue-50 transition-all duration-300 focus:outline-none js-color-option"
                                    ...
                                    data-color-name="<?php echo e($color->color_name); ?>"
                                    data-image-url="<?php echo e($colorMainImg); ?>"
                                    data-hex="<?php echo e(\App\Helpers\ColorHelper::getColorHex($color->color_name)); ?>"
                                    data-price-adjustment="<?php echo e((int) ($color->price_adjustment ?? 0)); ?>">
                            <div class="relative w-6 h-6 sm:w-7 sm:h-7 rounded-full mb-1.5 border-2 border-gray-300" data-bg-hex="<?php echo e(\App\Helpers\ColorHelper::getColorHex($color->color_name)); ?>" data-color-name="<?php echo e($color->color_name); ?>">
                                <i class="fas fa-check text-white text-[10px] absolute inset-0 m-auto w-3 h-3 flex items-center justify-center hidden"></i>
                            </div>
                            <span class="text-xs text-gray-700 font-medium truncate max-w-[90px]"><?php echo e($color->color_name); ?></span>
                            </button>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                ...
                <?php if($variant->colors->count() > 0): ?>
                    ...
                    ?>
                    <script>
                        window.variantColorStockData = <?php echo json_encode($colorStocksData, 15, 512) ?>;
                        ...
                        <div class="flex items-center gap-3">
                            <div class="text-2xl lg:text-3xl font-extrabold text-blue-700" aria-label="Giá">
                                <span id="dynamic-price"
                                      data-base-price="<?php echo e((int) $baseCurrent); ?>"
                                      data-base-original="<?php echo e((int) $baseOriginal); ?>"
                                      data-discount="<?php echo e($hasDiscount ? $discountPct : 0); ?>"><?php echo e(number_format($baseCurrent, 0, ',', '.')); ?></span>₫
                            </div>
                            <?php if($hasDiscount): ?>
                                <span class="text-sm lg:text-base text-gray-500 line-through">
                                    <span id="original-price"><?php echo e(number_format($baseOriginal, 0, ',', '.')); ?></span>₫
                                </span>
                                <span class="inline-flex items-center px-2 py-0.5 rounded-full bg-red-100 text-red-700 text-xs font-bold">-<?php echo e(rtrim(rtrim(number_format($discountPct, 1), '0'), '.')); ?>%</span>
                            <?php endif; ?>
                            
                            <div id="color-stock-badge" style="display:none"></div>
                        </div>
                        <?php if($variant->is_available): ?>
                        <form action="<?php echo e(route('user.cart.add')); ?>" method="POST" class="add-to-cart-form flex items-center gap-2" data-item-type="car_variant" data-item-id="<?php echo e($variant->id); ?>">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="item_type" value="car_variant">
                            <input type="hidden" name="item_id" value="<?php echo e($variant->id); ?>">
                ...
                <?php if($included->count() > 0 || $optional->count() > 0): ?>
                <div class="mt-6 space-y-4">
                    <h3 class="text-base font-semibold text-gray-900">Tính năng</h3>
                    <?php if($included->count() > 0): ?>
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php $__currentLoopData = $included; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="inline-flex items-center px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700 text-xs font-medium border border-emerald-100" title="<?php echo e($f->description); ?>"><?php echo e($f->feature_name); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                <?php endif; ?>

                    <?php if($optional->count() > 0): ?>
                        <div class="bg-white rounded-xl border p-3">
                        <div class="text-sm font-semibold text-indigo-700 mb-2 flex items-center gap-2"><i class="fas fa-plus-circle"></i> Tuỳ chọn thêm</div>
                            <div class="space-y-2">
                            <?php $__currentLoopData = $optional; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $fee = (float)($f->package_price ?? $f->price ?? 0); ?>
                                <label class="flex items-start gap-3">
                                    <input type="checkbox" name="feature_ids[]" class="mt-1 accent-indigo-600 js-feature" value="<?php echo e($f->id); ?>" data-fee="<?php echo e((int)$fee); ?>">
                                    <div class="min-w-0 flex-1">
                                        <div class="flex items-start gap-3">
                                            <span class="font-medium text-gray-900 flex-1"><?php echo e($f->feature_name); ?></span>
                                            <?php if($fee>0): ?>
                                                <span class="text-sm text-indigo-700 font-semibold whitespace-nowrap">+<?php echo e(number_format($fee,0,',','.')); ?>₫</span>
                                            <?php endif; ?>
                                        </div>
                                        <?php if(!empty($f->description)): ?>
                                            <div class="text-xs text-gray-600 mt-0.5"><?php echo e($f->description); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </label>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="mt-3 grid grid-cols-3 gap-2">
                    ...
                    ?>
                    <button type="button" class="action-btn action-ghost w-full js-wishlist-toggle <?php echo e($__inWishlistVarPage ? 'in-wishlist' : 'not-in-wishlist'); ?>" aria-label="Yêu thích" title="Yêu thích" aria-pressed="<?php echo e($__inWishlistVarPage ? 'true' : 'false'); ?>" data-item-type="car_variant" data-item-id="<?php echo e($variant->id); ?>">
                        <i class="fa-heart <?php echo e($__inWishlistVarPage ? 'fas' : 'far'); ?>"></i><span>Yêu thích</span>
                    </button>
                    <button type="button" class="action-btn action-ghost w-full js-compare-toggle" aria-label="So sánh" title="So sánh" data-variant-id="<?php echo e($variant->id); ?>">
                        <i class="fas fa-balance-scale"></i><span>So sánh</span>
                    </button>
                    <form action="<?php echo e(route('user.cart.add')); ?>" method="POST" class="w-full add-to-cart-form" data-item-type="car_variant" data-item-id="<?php echo e($variant->id); ?>">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="item_type" value="car_variant">
                        <input type="hidden" name="item_id" value="<?php echo e($variant->id); ?>">
        ...
        <div class="mt-16">
            <div class="border-b border-gray-200">
                <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                    ...
                    <?php if(($variant->options ?? collect())->count() > 0): ?>
                    ...
                    <div class="prose prose-lg max-w-none">
                        <div class="bg-white rounded-3xl shadow-xl p-8">
                            ...
                            <div class="text-gray-700 leading-relaxed">
                                <?php $desc = $variant->description ?? 'Chưa có mô tả chi tiết cho phiên bản này.'; ?>
                    ...
                    <div class="bg-white rounded-3xl shadow-xl p-8">
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
                                    ...
                                    <div class="rounded-xl border border-gray-100 overflow-hidden text-sm">
                                        <div class="grid grid-cols-1">
                                            <div class="flex justify-between items-center px-4 py-3 border-b border-gray-100 odd:bg-gray-50/60"><span class="text-gray-600">Phiên bản</span><span class="font-semibold text-gray-900 text-right ml-4"><?php echo e($variant->name); ?></span></div>
                                            <div class="flex justify-between items-center px-4 py-3 border-b border-gray-100 odd:bg-gray-50/60"><span class="text-gray-600">Dòng xe</span><span class="font-semibold text-gray-900 text-right ml-4"><?php echo e($variant->carModel->name ?? 'N/A'); ?></span></div>
                                            <div class="flex justify-between items-center px-4 py-3 border-b border-gray-100 odd:bg-gray-50/60"><span class="text-gray-600">Hãng</span><span class="font-semibold text-gray-900 text-right ml-4"><?php echo e($variant->carModel->carBrand->name ?? 'N/A'); ?></span></div>
                                            <div class="flex justify-between items-center px-4 py-3 border-b border-gray-100 odd:bg-gray-50/60"><span class="text-gray-600">Tình trạng</span><span class="font-semibold <?php echo e($variant->is_available ? 'text-green-600' : 'text-red-600'); ?> text-right ml-4"><?php echo e($variant->is_available ? 'Còn hàng' : 'Hết hàng'); ?></span></div>
                                    <?php if(!empty($variant->sku)): ?>
                                            <div class="flex justify-between items-center px-4 py-3 border-b border-gray-100 odd:bg-gray-50/60"><span class="text-gray-600">SKU</span><span class="font-semibold text-gray-900 text-right ml-4"><?php echo e($variant->sku); ?></span></div>
                                    <?php endif; ?>
                                            <div class="flex justify-between items-center px-4 py-3 border-b border-gray-100 odd:bg-gray-50/60"><span class="text-gray-600">Bảo hành</span><span class="font-semibold text-gray-900 text-right ml-4"><?php echo e($variant->warranty_info); ?></span></div>
                                    </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="lg:col-span-1">
                                <?php if(!empty($megaGroups)): ?>
                                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
                                        <div class="text-base font-semibold text-gray-900 mb-3">Thông số kỹ thuật</div>
                                        <div class="mb-4 flex flex-wrap gap-2">
                                            <?php $__currentLoopData = $megaGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mKey => $_): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <button type="button" class="spec-tab px-3 py-1.5 rounded-full text-sm font-medium shadow-sm <?php echo e($loop->first ? 'bg-indigo-600 text-white is-active' : 'bg-gray-100 text-gray-800'); ?>" data-spec-tab="<?php echo e($mKey); ?>"><?php echo e($megaLabels[$mKey] ?? Str::title(str_replace(['-','_'],' ', $mKey))); ?></button>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                        <?php $__currentLoopData = $megaGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mKey => $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="spec-tab-panel rounded-xl border border-gray-100 p-0 overflow-hidden text-sm <?php echo e(!$loop->first ? 'hidden' : ''); ?>" data-spec-panel="<?php echo e($mKey); ?>">
                                ...
                                ?>
                                                <div class="flex justify-between items-center px-4 py-3 border-b border-gray-100 odd:bg-gray-50/60">
                                                    <span class="text-gray-600"><?php echo e($row['label']); ?></span>
                                                    <span class="font-semibold text-gray-900 text-right ml-4"><?php echo e($v); ?></span>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                        ...
                        <div id="reviews-summary" class="mb-8">
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                <div class="lg:col-span-1 text-center bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100">
                                    <?php $avgRating = isset($approvedAvg) ? $approvedAvg : ($variant->approved_reviews_avg ?? 0); ?>
                                    <div id="reviews-avg" class="text-6xl font-black text-blue-600 mb-3"><?php echo e(number_format((float) $avgRating, 1)); ?></div>
                                    ...
                                    <?php $approvedCount2 = isset($approvedCount) ? $approvedCount : ($variant->approved_reviews_count ?? $variant->approvedReviews()->count()); ?>
                                    <div class="text-gray-700 font-medium text-lg">(<span id="reviews-count"><?php echo e(number_format($approvedCount2 ?? 0)); ?></span> đánh giá)</div>
                                </div>
                                        ...
                                        <?php for($star = 5; $star >= 1; $star--): ?>
                                            ...
                                            <div class="flex items-center gap-4">
                                                <div class="flex items-center gap-2 w-20">
                                                    <span class="text-sm font-medium text-gray-700"><?php echo e($star); ?></span>
                                                    <i class="fas fa-star text-yellow-400"></i>
                                                </div>
                                                <div class="flex-1 bg-gray-100 rounded-full h-3 overflow-hidden">
                                                    <div class="bg-gradient-to-r from-yellow-400 to-orange-400 h-3 rounded-full transition-all duration-500 ease-out rating-bar" data-star="<?php echo e($star); ?>" data-percentage="<?php echo e($percentage); ?>" style="width:0%"></div>
                                                </div>
                                                <div class="w-16 text-right">
                                                    <span class="text-sm font-medium text-gray-700 review-star-count" data-star="<?php echo e($star); ?>"><?php echo e($starCount); ?></span>
                                                </div>
                                            </div>
                                        <?php endfor; ?>
                                    </div>
                        ...
                        <div id="review-modal" class="fixed inset-0 z-[10000] bg-black/60 hidden" style="display:none; align-items:center; justify-content:center;" role="dialog" aria-modal="true" aria-labelledby="review-modal-title">
                            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-5 relative">
                                ...
                                <form id="review-form" class="space-y-3">
                                    ...
                                    <input type="hidden" name="reviewable_id" value="<?php echo e($variant->id); ?>">
                                    <div>
                                        <label class="block text-sm text-gray-700 mb-1">Chấm sao <span class="text-red-500">*</span></label>
                                        <div class="flex items-center gap-2">
                                            <?php for($i=1;$i<=5;$i++): ?>
                                            <label class="inline-flex items-center gap-1 cursor-pointer">
                                                <input type="radio" name="rating" value="<?php echo e($i); ?>" class="accent-yellow-500">
                                                <i class="fas fa-star text-yellow-400"></i>
                                            </label>
                                            <?php endfor; ?>
                                        </div>
        ...
        <!-- Related Products -->
        <?php if(isset($relatedVariants) && $relatedVariants->count() > 0): ?>
        ...
        <div class="text-center mb-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <?php $__currentLoopData = $relatedVariants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo $__env->make('components.variant-card', ['variant' => $related, 'showCompare' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    (function initReviews(){
        ...
        let currentPage = 1; const perPage = 10; const reviewableId = Number('<?php echo e($variant->id); ?>');
        ...
        function updateInlineSummary(){
            ...
            fetch(`<?php echo e(route('reviews.summary')); ?>?reviewable_type=${type}&reviewable_id=${reviewableId}`,{headers:{'X-Requested-With':'XMLHttpRequest'}})
        ...
        function load(page){
            const type = 'App%5CModels%5CCarVariant';
            fetch(`<?php echo e(route('reviews.get')); ?>?reviewable_type=${type}&reviewable_id=${reviewableId}&page=${page}`,{headers:{'X-Requested-With':'XMLHttpRequest'}})
        ...
        if (formEl){
            formEl.addEventListener('submit', function(ev){ 
                ...
                if (errorBox){ errorBox.classList.add('hidden'); errorBox.innerHTML=''; }
                fetch(`<?php echo e(route('reviews.store')); ?>`,{method:'POST', headers:{'X-Requested-With':'XMLHttpRequest','X-CSRF-TOKEN':document.querySelector('meta[name="csrf-token"]').content}, body:fd})
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\forev\showroom-car-modern\resources\views/user/car-variants/show.blade.php ENDPATH**/ ?>
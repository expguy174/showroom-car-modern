...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 max-w-7xl mx-auto">
    ...
    <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('admin.payment-methods.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white text-sm font-medium rounded-lg transition-colors">
    ...
    <form id="paymentMethodForm" action="<?php echo e(route('admin.payment-methods.store')); ?>" method="POST" class="p-6" novalidate>
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('name')); ?>" placeholder="VD: Thẻ tín dụng Visa">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="provider" id="provider"
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['provider'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('provider')); ?>" placeholder="VD: Visa, MasterCard, VNPay">
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('code')); ?>" placeholder="VD: cash, vnpay, momo">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="type" id="type" 
                                    class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <option value="online" <?php echo e(old('type') == 'online' ? 'selected' : ''); ?>>Trực tuyến</option>
                                <option value="offline" <?php echo e(old('type') == 'offline' ? 'selected' : ''); ?>>Trực tiếp</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" 
                                      placeholder="Ghi chú về phương thức thanh toán..."><?php echo e(old('notes')); ?></textarea>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="number" name="fee_flat" id="fee_flat" step="1000" min="0"
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['fee_flat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="fee_percent" id="fee_percent" step="0.01" min="0" max="100"
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['fee_percent'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('sort_order', 0)); ?>" placeholder="0">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mt-8 pt-6 border-t border-gray-200">
            <div class="flex items-center justify-between">
                <a href="<?php echo e(route('admin.payment-methods.index')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
...
document.getElementById('paymentMethodForm').addEventListener('submit', function(e) {
    ...
    .then(data => {
        if (data.success) {
            ...
            setTimeout(() => {
                window.location.href = data.redirect || '<?php echo e(route("admin.payment-methods.index")); ?>';
            }, 1500);
        } else {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\forev\showroom-car-modern\resources\views/admin/payment-methods/create.blade.php ENDPATH**/ ?>
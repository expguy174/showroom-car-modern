...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 max-w-7xl mx-auto">
    ...
    <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Thêm đại lý phân phối mới vào hệ thống</p>
            </div>
    ...
    <form id="dealershipForm" action="<?php echo e(route('admin.dealerships.store')); ?>" method="POST" class="p-6">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4"
                                class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Nhập mô tả về đại lý..."><?php echo e(old('description')); ?></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="country" id="country"
                                class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="<?php echo e(old('country', 'Vietnam')); ?>"
                                placeholder="Vietnam">
                        </div>
...
<script>
    ...
    document.getElementById('dealershipForm').addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (response.ok) {
                if (window.showMessage) {
                    window.showMessage(data.message || 'Đã thêm đại lý thành công!', 'success');
                }
            ...
            if (window.showMessage) {
                window.showMessage(error.message || 'Có lỗi xảy ra khi thêm đại lý!', 'error');
            }
        } finally {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\forev\showroom-car-modern\resources\views/admin/dealerships/create.blade.php ENDPATH**/ ?>
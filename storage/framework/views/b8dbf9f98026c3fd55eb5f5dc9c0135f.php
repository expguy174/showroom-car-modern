    ...
    <?php else: ?>
        ...
        <div class="flex gap-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
            <div class="flex-shrink-0">
                ...
                <?php elseif($log->action == 'refund_request'): ?>
                ...
                <?php elseif($log->action == 'down_payment_confirmed'): ?>
                    <div class="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
                        <i class="fas fa-hand-holding-usd text-green-600 text-sm"></i>
                    </div>
                <?php elseif($log->action == 'user_cancel'): ?>
                    <div class="w-8 h-8 bg-red-100 rounded-full flex items-center justify-center">
                ...
                <div class="text-xs text-gray-600 mt-2">
                    ...
                    <div class="mt-2 p-3 bg-indigo-50 border border-indigo-200 rounded space-y-2">
                        <div class="flex items-center gap-2 text-xs">
                            ...
                            <span class="text-gray-700"><?php echo e($log->details['from_label'] ?? $log->details['from_status']); ?></span>
                            <i class="fas fa-arrow-right text-gray-400 text-xs"></i>
                            <span class="font-medium text-indigo-600"><?php echo e($log->details['to_label'] ?? $log->details['to_status']); ?></span>
                        </div>
                        ...
                        <div class="flex items-center justify-between text-xs bg-white border border-indigo-200 rounded px-2 py-1.5">
                            ...
                            <span class="font-bold text-indigo-600"><?php echo e(number_format($log->details['amount'], 0, ',', '.')); ?> VNĐ</span>
                        </div>
                        <?php endif; ?>
                        <?php if(isset($log->details['admin_notes']) && $log->details['admin_notes']): ?>
                        <div class="text-xs">
                            <span class="text-gray-600">Ghi chú:</span>
                            <p class="text-gray-700 mt-1"><?php echo e($log->details['admin_notes']); ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                    ...
                    <?php if($log->action === 'order_cancelled'): ?>
                    <div class="mt-2 p-3 bg-red-50 border border-red-200 rounded space-y-2">
                        ...
                        <?php if(isset($log->details['order_status'])): ?>
                        <div class="flex items-center gap-2 text-xs">
                            <span class="text-gray-600">Trạng thái đơn:</span>
                            <span class="text-gray-700"><?php echo e($orderStatusLabels[$log->details['order_status']['from']] ?? $log->details['order_status']['from']); ?></span>
                            <i class="fas fa-arrow-right text-gray-400 text-xs"></i>
                            <span class="font-medium text-red-600"><?php echo e($orderStatusLabels[$log->details['order_status']['to']] ?? 'Đã hủy'); ?></span>
                        </div>
                        <?php endif; ?>
                        
                        <?php if(isset($log->details['payment_status'])): ?>
                        <div class="flex items-center gap-2 text-xs">
                            <span class="text-gray-600">Thanh toán:</span>
                            <span class="text-gray-700"><?php echo e($paymentStatusLabels[$log->details['payment_status']['from']] ?? $log->details['payment_status']['from']); ?></span>
                            <i class="fas fa-arrow-right text-gray-400 text-xs"></i>
                            <span class="font-medium <?php echo e($log->details['payment_status']['to'] === 'refunded' ? 'text-green-600' : 'text-red-600'); ?>">
                                <?php echo e($paymentStatusLabels[$log->details['payment_status']['to']] ?? $log->details['payment_status']['to']); ?>

                            </span>
                        </div>
                        <?php endif; ?>
                        
                        <?php if(isset($log->details['cancelled_installments']) && $log->details['cancelled_installments'] > 0): ?>
                        <div class="flex items-center gap-2 text-xs">
                            <i class="fas fa-calendar-times text-red-500"></i>
                            <span class="text-gray-600">Đã hủy:</span>
                            <span class="font-medium text-red-700"><?php echo e($log->details['cancelled_installments']); ?> kỳ trả góp</span>
                        </div>
                        <?php endif; ?>
                        
                        <?php if(isset($log->details['refund_id']) && isset($log->details['refund_amount'])): ?>
                        <div class="flex items-center justify-between text-xs bg-amber-50 border border-amber-200 rounded px-2 py-1.5">
                            ...
                            <span class="font-bold text-amber-600"><?php echo e(number_format($log->details['refund_amount'], 0, ',', '.')); ?> VNĐ</span>
                        </div>
                        <?php endif; ?>
                        
                        <?php if(isset($log->details['reason']) && $log->details['reason']): ?>
                        <div class="text-xs">
                            <span class="text-gray-600">Lý do:</span>
                            <p class="text-gray-700 mt-1">
                                <?php if($log->details['reason'] === 'Auto-cancelled after refund completed'): ?>
                                    Tự động hủy sau khi hoàn tiền thành công
                                <?php else: ?>
                                    <?php echo e($log->details['reason']); ?>
                        ...
                        <?php if(isset($log->details['cancelled_by'])): ?>
                        <div class="text-xs text-gray-500 flex items-center gap-1">
                            <i class="fas fa-user-shield"></i>
                            <span>Bởi: <?php echo e($log->details['cancelled_by']); ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                    ...
                    <?php if($log->action === 'down_payment_confirmed' && isset($log->details['down_payment_amount'])): ?>
                    <div class="mt-2 p-3 bg-green-50 border border-green-200 rounded">
                        <div class="flex items-center justify-between text-xs">
                            <div class="flex items-center gap-2">
                                <span class="text-gray-600">Số tiền cọc:</span>
                                <span class="font-medium text-green-700"><?php echo e(number_format($log->details['down_payment_amount'], 0, ',', '.')); ?> VNĐ</span>
                            </div>
                            <?php if(isset($log->details['payment_status_to'])): ?>
                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                <?php echo e($log->details['payment_status_to'] === 'partial' ? 'Thanh toán một phần' : $log->details['payment_status_to']); ?>
                        ...
                        <div class="mt-1 text-xs">
                            ...
                            <span class="font-medium"><?php echo e($paymentMethodName); ?></span>
                        </div>
                        <?php endif; ?>

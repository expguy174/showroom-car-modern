...
<div class="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8">
    <div class="flex items-center justify-between mb-4 sm:mb-6">
        ...
        <div class="hidden sm:flex items-center gap-2">
            <a href="<?php echo e(route('products.index')); ?>" class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 text-sm font-semibold">
                <i class="fas fa-shopping-bag"></i> Mua thêm
            </a>
        </div>
    </div>

    <form id="orders-filter-form" action="<?php echo e(route('user.order.index')); ?>" method="get" class="mb-4 sm:mb-6">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Tìm kiếm</label>
                    <div class="relative">
                        <input type="text" name="q" value="<?php echo e($q ?? request('q')); ?>" placeholder="Mã đơn, mã vận đơn..." class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 pr-10">
                ...
                <div>
                    ...
                    <select name="status" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <?php $__currentLoopData = \App\Models\Order::STATUSES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($st); ?>" <?php if(($status ?? request('status')) === $st): echo 'selected'; endif; ?>><?php echo e((new \App\Models\Order(['status'=>$st]))->status_display); ?></option>
                ...
                <div>
                    ...
                    <select name="payment_status" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <?php $__currentLoopData = $__allowedPaymentStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($pst); ?>" <?php if(($payment_status ?? request('payment_status')) === $pst): echo 'selected'; endif; ?>><?php echo e((new \App\Models\Order(['payment_status'=>$pst]))->payment_status_display); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
    ...
    <div id="orders-summary-host">
        <?php echo $__env->make('user.orders.partials.summary', ['paginator' => $orders->withQueryString()], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
    <div id="orders-list-wrapper">
        <?php echo $__env->make('user.orders.partials.list', ['orders' => $orders], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>

    <div id="orders-pagination" class="mt-6">
        <?php echo $__env->make('components.pagination-modern', ['paginator' => $orders->withQueryString()], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\forev\showroom-car-modern\resources\views/user/orders/index.blade.php ENDPATH**/ ?>
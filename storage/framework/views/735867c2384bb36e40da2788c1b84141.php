<?php $__env->startSection('title', 'Chi tiết lịch hẹn #' . $appointment->appointment_number); ?>
...
<?php endif; ?>
    ...
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center space-x-4">
            <a href="<?php echo e(route('admin.service-appointments.index')); ?>" 
               class="text-gray-600 hover:text-gray-900">
                <i class="fas fa-arrow-left"></i>
            </a>
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Chi tiết lịch hẹn</h1>
                <p class="text-sm text-gray-500 mt-1"><?php echo e($appointment->appointment_number); ?></p>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="font-medium text-gray-900"><?php echo e($appointment->user->userProfile->name ?? 'N/A'); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500">Email</p>
                        <p class="font-medium text-gray-900"><?php echo e($appointment->user->email); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500">Số điện thoại</p>
                        <p class="font-medium text-gray-900"><?php echo e($appointment->user->userProfile->phone ?? 'N/A'); ?></p>
                    </div>
                    <div>
                        ...
                        <p class="font-medium text-gray-900">
                            ...
                            ?>
                            <?php echo e($defaultAddress ? $defaultAddress->address . ', ' . $defaultAddress->city : 'N/A'); ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="font-medium text-gray-900"><?php echo e($appointment->service->name ?? 'N/A'); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500">Showroom</p>
                        <p class="font-medium text-gray-900"><?php echo e($appointment->showroom->name ?? 'N/A'); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500">Ngày hẹn</p>
                        <p class="font-medium text-gray-900"><?php echo e($appointment->appointment_date ? $appointment->appointment_date->format('d/m/Y') : '-'); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500">Giờ hẹn</p>
                        <p class="font-medium text-gray-900"><?php echo e($appointment->appointment_time ?? '-'); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500">Chi phí dự kiến</p>
                        <p class="font-medium text-gray-900"><?php echo e($appointment->estimated_cost ? number_format($appointment->estimated_cost, 0, ',', '.') . 'đ' : '-'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="font-medium text-gray-900"><?php echo e($appointment->vehicle_registration ?? 'N/A'); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500">Số km hiện tại</p>
                        <p class="font-medium text-gray-900"><?php echo e($appointment->current_mileage ? number_format($appointment->current_mileage) . ' km' : 'N/A'); ?></p>
                    </div>
                    <?php if($appointment->carVariant): ?>
                    <div class="col-span-2">
                        <p class="text-sm text-gray-500">Dòng xe</p>
                        <p class="font-medium text-gray-900">
                            <?php echo e($appointment->carVariant->carModel->carBrand->name ?? ''); ?> 
                            <?php echo e($appointment->carVariant->carModel->name ?? ''); ?> 
                            <?php echo e($appointment->carVariant->name ?? ''); ?>
                    ...
                    <div class="col-span-2">
                        ...
                        <span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium <?php echo e($appointment->is_warranty_work ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                            <?php echo e($appointment->is_warranty_work ? 'Có' : 'Không'); ?>
            ...
            <?php if($appointment->requested_services || $appointment->service_description): ?>
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h2 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                    <i class="fas fa-list-check text-blue-600 mr-2"></i>
                    Yêu cầu dịch vụ
                </h2>
                <?php if($appointment->requested_services): ?>
                <div class="mb-4">
                    <p class="text-sm text-gray-500 mb-2">Dịch vụ yêu cầu</p>
                    <div class="text-sm text-gray-900 whitespace-pre-line"><?php echo e($appointment->requested_services); ?></div>
                </div>
                <?php endif; ?>
                <?php if($appointment->service_description): ?>
                <div>
                    <p class="text-sm text-gray-500 mb-2">Mô tả chi tiết</p>
                    <div class="text-sm text-gray-900 whitespace-pre-line"><?php echo e($appointment->service_description); ?></div>
                </div>
                <?php endif; ?>
            </div>
            <?php endif; ?>
            ...
            <?php if($appointment->status == 'completed' && ($appointment->satisfaction_rating || $appointment->feedback)): ?>
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h2 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                    <i class="fas fa-star text-yellow-500 mr-2"></i>
                    Đánh giá của khách hàng
                </h2>
                <?php if($appointment->satisfaction_rating): ?>
                <div class="mb-4">
                    <p class="text-sm text-gray-500 mb-2">Đánh giá</p>
                    <div class="flex items-center">
                        <?php for($i = 1; $i <= 5; $i++): ?>
                            <i class="fas fa-star <?php echo e($i <= $appointment->satisfaction_rating ? 'text-yellow-400' : 'text-gray-300'); ?>"></i>
                        <?php endfor; ?>
                        <span class="ml-2 text-sm text-gray-600">(<?php echo e($appointment->satisfaction_rating); ?>/5)</span>
                    </div>
                </div>
                <?php endif; ?>
                <?php if($appointment->feedback): ?>
                <div>
                    <p class="text-sm text-gray-500 mb-2">Nhận xét</p>
                    <div class="text-sm text-gray-900 whitespace-pre-line"><?php echo e($appointment->feedback); ?></div>
                </div>
                <?php endif; ?>
            </div>
            <?php endif; ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-900"><?php echo e($appointment->created_at->format('d/m/Y H:i')); ?></p>
                    </div>
...
<script>
const appointmentId = <?php echo e($appointment->id); ?>;
let currentStatus = '<?php echo e($appointment->status); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\forev\showroom-car-modern\resources\views/admin/service-appointments/show.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Tin tức & Blog - AutoLux'); ?>
        ...
        <div class="max-w-7xl mx-auto">
                ...
                <article class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
                        <div class="relative h-64 lg:h-full overflow-hidden">
                            <img src="<?php echo e($blogs->first()->image_url ?? asset('images/default-blog.jpg')); ?>" 
                                 alt="<?php echo e($blogs->first()->title); ?>" 
                        ...
                        <div class="p-8 lg:p-12 flex flex-col justify-center">
                            <div class="flex items-center text-sm text-gray-500 mb-4">
                                ...
                                <?php echo e($blogs->first()->created_at->format('d/m/Y')); ?>

                                <span class="mx-3 text-gray-300">•</span>
                                <i class="fas fa-clock text-purple-500 mr-2"></i>
                                <?php echo e($blogs->first()->created_at->diffForHumans()); ?>
                            ...
                            <h3 class="text-2xl lg:text-3xl font-bold text-gray-900 mb-4 leading-tight hover:text-purple-600 transition-colors duration-300">
                                <a href="<?php echo e(route('blogs.show', $blogs->first()->id)); ?>">
                                    <?php echo e($blogs->first()->title); ?>

                                </a>
                            </h3>
                            
                            <p class="text-gray-600 mb-6 leading-relaxed text-lg">
                                <?php echo e(Str::limit($blogs->first()->content, 200)); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <article class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                    <div class="relative h-48 overflow-hidden">
                        <img src="<?php echo e($blog->image_url ?? asset('images/default-blog.jpg')); ?>" 
            ...
            <div class="mt-16 flex justify-center">
                <div class="flex items-center space-x-2">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e($blogs->previousPageUrl()); ?>" class="px-4 py-2 text-gray-600 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                            <i class="fas fa-chevron-left mr-2"></i>Trước
                        </a>
                    <?php endif; ?>
                    ...
                    <?php $__currentLoopData = $blogs->getUrlRange(1, $blogs->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($page == $blogs->currentPage()): ?>
                            <span class="px-4 py-2 bg-blue-600 text-white rounded-lg font-semibold"><?php echo e($page); ?></span>
                        <?php else: ?>
                    ...
                    <?php if($blogs->hasMorePages()): ?>
                        <a href="<?php echo e($blogs->nextPageUrl()); ?>" class="px-4 py-2 text-gray-600 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-200">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\forev\showroom-car-modern\resources\views/user/blogs/index.blade.php ENDPATH**/ ?>
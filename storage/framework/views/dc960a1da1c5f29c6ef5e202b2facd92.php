    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="h-16 flex items-center justify-between gap-2">
            ...
            <div class="center-menu hidden lg:flex items-center justify-center gap-1 text-[13px] flex-1 min-w-0 h-16">
                ...
                <div class="dropdown-group car-dropdown-wrapper" data-dropdown="brands">
                    ...
                    <div class="dropdown-menu absolute left-0 mt-2 w-[720px] z-50 opacity-0 invisible scale-95 transition-all duration-200 transform origin-top-left pointer-events-auto" data-dropdown-menu>
                        <div class="p-3 grid grid-cols-3 gap-2">
                            <?php $__empty_1 = true; $__currentLoopData = $navBrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <a href="<?php echo e(route('car-brands.show', $brand->id)); ?>" class="flex items-center gap-3 p-2 rounded-lg hover:bg-white transition-colors duration-150">
                                <?php
                                ...
                                ?>
                                <img src="<?php echo e($logoSrc); ?>" alt="<?php echo e($brand->name); ?>" class="w-8 h-8 object-contain rounded" loading="lazy" onerror="this.onerror=null;this.src='https://placehold.co/40x40?text=%2B';" />
                                <div class="min-w-0">
                                    <div class="font-semibold text-sm truncate"><?php echo e($brand->name); ?></div>
                                    <?php $modelsCount = $brand->relationLoaded('carModels') ? $brand->carModels->count() : ($brand->carModels()->count()); ?>
                                    <div class="text-xs text-gray-500 truncate"><i class="fas fa-layer-group text-gray-400 mr-1"></i><?php echo e(number_format($modelsCount)); ?> dòng xe</div>
                                </div>
                            </a>
                        ...
                        <div class="px-3 pb-3 flex items-center justify-end">
                            <a href="<?php echo e(route('car-brands.index')); ?>" class="text-sm text-indigo-700 hover:underline inline-flex items-center gap-1 transition-colors duration-150">
                ...
                <div class="dropdown-group" data-dropdown="inventory">
                    ...
                    <div class="dropdown-menu absolute left-0 mt-2 min-w-[260px] z-50 opacity-0 invisible scale-95 transition-all duration-200 transform origin-top-left pointer-events-auto" data-dropdown-menu>
                        <div class="p-2">
                            <a href="<?php echo e(route('products.index')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white transition-colors duration-150"><i class="fas fa-th-large text-gray-400"></i><span>Tất cả</span></a>
                            <a href="<?php echo e(route('products.index', ['type' => 'car'])); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white transition-colors duration-150"><i class="fas fa-car-side text-gray-400"></i><span>Xe hơi</span></a>
                            <a href="<?php echo e(route('products.index', ['type' => 'accessory'])); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white transition-colors duration-150"><i class="fas fa-puzzle-piece text-gray-400"></i><span>Phụ kiện</span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="dropdown-group" data-dropdown="finance">
                    ...
                    <div class="dropdown-menu absolute left-0 mt-2 min-w-[260px] z-50 opacity-0 invisible scale-95 transition-all duration-200 transform origin-top-left pointer-events-auto" data-dropdown-menu>
                        <div class="p-2">
                            <a href="<?php echo e(route('finance.index')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white transition-colors duration-150"><i class="fas fa-info-circle text-gray-400"></i><span>Tổng quan</span></a>
                            <a href="<?php echo e(route('finance.calculator')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white transition-colors duration-150"><i class="fas fa-calculator text-gray-400"></i><span>Máy tính trả góp</span></a>
                            <a href="<?php echo e(route('finance.requirements')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white transition-colors duration-150"><i class="fas fa-clipboard-list text-gray-400"></i><span>Điều kiện vay</span></a>
                            <a href="<?php echo e(route('finance.faq')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white transition-colors duration-150"><i class="fas fa-question-circle text-gray-400"></i><span>FAQ</span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="dropdown-group" data-dropdown="info">
                    ...
                    <div class="dropdown-menu absolute left-0 mt-2 min-w-[260px] z-50 opacity-0 invisible scale-95 transition-all duration-200 transform origin-top-left pointer-events-auto" data-dropdown-menu>
                        <div class="p-2 grid grid-cols-1 gap-1">
                            <a href="<?php echo e(route('blogs.index')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white transition-colors duration-150"><i class="fas fa-newspaper text-gray-400"></i><span>Tin tức</span></a>
                            <a href="<?php echo e(route('user.promotions.index')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white transition-colors duration-150"><i class="fas fa-tags text-gray-400"></i><span>Khuyến mãi</span></a>
                            <a href="<?php echo e(route('user.showrooms.index')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white transition-colors duration-150"><i class="fas fa-store text-gray-400"></i><span>Showroom</span></a>
                            <a href="<?php echo e(route('about')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white transition-colors duration-150"><i class="fas fa-info-circle text-gray-400"></i><span>Về chúng tôi</span></a>
                            <a href="<?php echo e(route('contact')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white transition-colors duration-150"><i class="fas fa-phone text-gray-400"></i><span>Liên hệ tư vấn</span></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="nav-actions" class="flex items-center gap-1 sm:gap-2 shrink-0 h-16">
                ...
                <form action="<?php echo e(route('products.index')); ?>" method="GET" class="hidden lg:flex items-center self-center h-16 m-0 mb-0">
                    <div class="relative h-full flex items-center">
                        ...
                        <div class="search-suggestions absolute left-0 right-0 top-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg hidden z-50">
                            ...
                            <div class="px-2 py-1 text-xs text-gray-500 border-t"><a href="<?php echo e(route('search.advanced')); ?>" class="hover:underline">Tìm kiếm nâng cao</a></div>
                        </div>
                    </div>
                </form>
                ...
                <a href="<?php echo e(route('wishlist.index')); ?>" class="relative inline-flex items-center justify-center w-10 h-10 rounded-full text-gray-600 hover:text-red-600 hover:bg-red-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500">
                    <i class="fas fa-heart"></i>
                    <span id="wishlist-count-badge" class="wishlist-count absolute -top-1 -right-1 w-5 h-5 text-[10px] rounded-full bg-red-500 text-white flex items-center justify-center <?php echo e($navWishlistCount > 0 ? 'flex' : 'hidden'); ?>"><?php echo e($navWishlistCount > 99 ? '99+' : $navWishlistCount); ?></span>
                    <span class="sr-only">Danh sách yêu thích</span>
                </a>

                
                <a href="<?php echo e(route('user.cart.index')); ?>" class="relative inline-flex items-center justify-center w-10 h-10 rounded-full text-gray-600 hover:text-indigo-700 hover:bg-indigo-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500">
                    <i class="fas fa-shopping-cart"></i>
                    <span id="cart-count-badge" class="cart-count absolute -top-1 -right-1 w-5 h-5 text-[10px] rounded-full bg-indigo-600 text-white flex items-center justify-center <?php echo e($navCartCount > 0 ? 'flex' : 'hidden'); ?>"><?php echo e($navCartCount > 99 ? '99+' : $navCartCount); ?></span>
                ...
                <div class="dropdown-group notif-dropdown lg:hidden" data-dropdown="notifications-mobile">
                    <button class="relative inline-flex items-center justify-center w-10 h-10 rounded-full text-gray-600 hover:bg-amber-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500" data-dropdown-trigger>
                        ...
                        <span id="notif-count-badge-mobile" class="notification-count absolute -top-1 -right-1 w-5 h-5 text-[10px] rounded-full bg-amber-500 text-white items-center justify-center <?php echo e($navUnreadNotifCount ? 'flex' : 'hidden'); ?>"><?php echo e($navUnreadNotifCount > 99 ? '99+' : $navUnreadNotifCount); ?></span>
                    ...
                    <div class="dropdown-menu absolute right-0 mt-2 w-[320px] max-w-[90vw] z-50 opacity-0 invisible scale-95 transition-all duration-200 transform origin-top-right" data-dropdown-menu>
                        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                            ...
                            <div class="px-4 py-3 border-t bg-gray-50 text-right">
                                <a href="<?php echo e(route('notifications.index')); ?>" class="text-sm text-amber-700 hover:underline">Xem tất cả</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="dropdown-group notif-dropdown hidden lg:block" data-dropdown="notifications">
                    <button class="relative inline-flex items-center justify-center w-10 h-10 rounded-full text-gray-600 hover:bg-amber-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500" data-dropdown-trigger>
                        <i class="fas fa-bell"></i>
                        <span id="notif-count-badge" class="notification-count absolute -top-1 -right-1 w-5 h-5 text-[10px] rounded-full bg-amber-500 text-white items-center justify-center <?php echo e($navUnreadNotifCount ? 'flex' : 'hidden'); ?>"><?php echo e($navUnreadNotifCount > 99 ? '99+' : $navUnreadNotifCount); ?></span>
                        <span class="sr-only">Thông báo</span>
                    </button>
                    <div class="dropdown-bridge"></div>
                ...
                <div class="profile-dropdown-wrapper dropdown-group hidden lg:block">
                    <button class="px-2.5 py-2 rounded-lg border border-gray-200 text-sm text-gray-700 hover:text-white hover:bg-gray-900 inline-flex items-center gap-2" data-dropdown-trigger>
                        <?php if(auth()->guard()->check()): ?>
                            ...
                            ?>
                            <img src="<?php echo e($avatar); ?>" alt="avatar" class="w-8 h-8 rounded-full object-cover" onerror="this.onerror=null;this.src='<?php echo e($fallback); ?>';" />
                    ...
                    <div class="dropdown-menu profile-dropdown-menu absolute right-0 mt-2 min-w-[240px] z-50">
                        <div class="p-2">
                            ...
                            <div class="px-3 py-2">
                                ...
                                <div>
                                    <div class="text-[11px] inline-flex items-center gap-1 text-indigo-600">
                                        ...
                                        ?>
                                        <i class="fas fa-user"></i> <?php echo e($customerTypeLabel); ?>

                                    </div>
                                    <div class="mt-1 text-sm font-semibold text-gray-900 truncate">Xin chào, <?php echo e($name); ?></div>
                                    <div class="mt-3 border-t border-gray-100"></div>
                                </div>
                            </div>
                            <?php if(auth()->user()->isStaff()): ?>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white">
                            ...
                            <?php endif; ?>
                            <a href="<?php echo e(route('user.profile.index')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white">
                            ...
                            <a href="<?php echo e(route('user.order.index')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white">
                            ...
                            <a href="<?php echo e(route('user.service-appointments.index')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white">
                            ...
                            <a href="<?php echo e(route('test-drives.index')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white">
                            ...
                            <?php else: ?>
                            <a href="<?php echo e(route('login', ['redirect' => request()->fullUrl()])); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white"><i class="fas fa-sign-in-alt text-gray-400"></i><span>Đăng nhập</span></a>
                            <a href="<?php echo e(route('register')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-white"><i class="fas fa-user-plus text-gray-400"></i><span>Tạo tài khoản</span></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
        ...
        <div id="drawer-panel" class="drawer-panel fixed top-0 right-0 left-auto h-auto max-h-[90vh] w-[92vw] sm:w-[360px] md:w-[420px] max-w-[95vw] bg-white shadow-2xl translate-x-full transition-transform duration-200 overflow-y-auto">
            ...
            <div class="p-4 space-y-2">
                ...
                <div>
                    ...
                    <div class="mobile-dropdown-content pl-2">
                        <div class="grid grid-cols-1 gap-1 max-h-64 overflow-y-auto pr-2">
                            <?php $__currentLoopData = $navBrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('car-brands.show', $brand->id)); ?>" class="flex items-center gap-3 px-4 py-2 rounded-md hover:bg-gray-50 transition-colors duration-150">
                                <img src="<?php echo e($brand->logo_url); ?>" alt="<?php echo e($brand->name); ?>" class="w-6 h-6 object-contain rounded" loading="lazy" onerror="this.onerror=null;this.src='https://placehold.co/32x32?text=%2B';" />
                                <span class="text-sm flex-1 truncate"><?php echo e($brand->name); ?></span>
                                <?php $modelsCount = $brand->relationLoaded('carModels') ? $brand->carModels->count() : ($brand->carModels()->count()); ?>
                                <span class="text-[11px] text-gray-500 whitespace-nowrap"><i class="fas fa-layer-group mr-1 text-gray-400"></i><?php echo e(number_format($modelsCount)); ?></span>
                            </a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('car-brands.index')); ?>" class="px-4 py-2 text-sm text-indigo-700 hover:underline">Xem tất cả hãng</a>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mobile-dropdown-content">
                        <div class="grid grid-cols-1 gap-1 pl-2 pr-2">
                            <a href="<?php echo e(route('products.index')); ?>" class="px-4 py-2 rounded-md hover:bg-gray-50 flex items-center gap-2"><i class="fas fa-th-large text-gray-400"></i><span>Tất cả</span></a>
                            <a href="<?php echo e(route('products.index', ['type' => 'car'])); ?>" class="px-4 py-2 rounded-md hover:bg-gray-50 flex items-center gap-2"><i class="fas fa-car-side text-gray-400"></i><span>Xe hơi</span></a>
                            <a href="<?php echo e(route('products.index', ['type' => 'accessory'])); ?>" class="px-4 py-2 rounded-md hover:bg-gray-50 flex items-center gap-2"><i class="fas fa-puzzle-piece text-gray-400"></i><span>Phụ kiện</span></a>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mobile-dropdown-content">
                        <div class="grid grid-cols-1 gap-1 pl-2 pr-2">
                            <a href="<?php echo e(route('finance.index')); ?>" class="px-4 py-2 rounded-md hover:bg-gray-50 flex items-center gap-2"><i class="fas fa-info-circle text-gray-400"></i><span>Tổng quan</span></a>
                            <a href="<?php echo e(route('finance.calculator')); ?>" class="px-4 py-2 rounded-md hover:bg-gray-50 flex items-center gap-2"><i class="fas fa-calculator text-gray-400"></i><span>Máy tính trả góp</span></a>
                            <a href="<?php echo e(route('finance.requirements')); ?>" class="px-4 py-2 rounded-md hover:bg-gray-50 flex items-center gap-2"><i class="fas fa-clipboard-list text-gray-400"></i><span>Điều kiện vay</span></a>
                            <a href="<?php echo e(route('finance.faq')); ?>" class="px-4 py-2 rounded-md hover:bg-gray-50 flex items-center gap-2"><i class="fas fa-question-circle text-gray-400"></i><span>FAQ</span></a>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mobile-dropdown-content">
                        <div class="grid grid-cols-1 gap-1 pl-2 pr-2">
                            <a href="<?php echo e(route('blogs.index')); ?>" class="px-4 py-2 rounded-md hover:bg-gray-50 flex items-center gap-2"><i class="fas fa-newspaper text-gray-400"></i><span>Tin tức</span></a>
                            <a href="<?php echo e(route('user.promotions.index')); ?>" class="px-4 py-2 rounded-md hover:bg-gray-50 flex items-center gap-2"><i class="fas fa-tags text-gray-400"></i><span>Khuyến mãi</span></a>
                            <a href="<?php echo e(route('user.showrooms.index')); ?>" class="px-4 py-2 rounded-md hover:bg-gray-50 flex items-center gap-2"><i class="fas fa-store text-gray-400"></i><span>Showroom</span></a>
                            <a href="<?php echo e(route('about')); ?>" class="px-4 py-2 rounded-md hover:bg-gray-50 flex items-center gap-2"><i class="fas fa-info-circle text-gray-400"></i><span>Về chúng tôi</span></a>
                            <a href="<?php echo e(route('contact')); ?>" class="px-4 py-2 rounded-md hover:bg-gray-50 flex items-center gap-2"><i class="fas fa-phone text-gray-400"></i><span>Liên hệ tư vấn</span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="pt-4 mt-2 border-t">
                    ...
                    <a href="<?php echo e(route('user.cart.index')); ?>" class="block px-4 py-3 rounded-lg hover:bg-gray-50 relative">
                        <i class="fas fa-shopping-cart mr-3 text-gray-400"></i>Giỏ hàng
                        <span id="cart-count-badge-mobile" class="cart-count absolute top-2 right-2 w-5 h-5 text-[10px] rounded-full bg-indigo-600 text-white flex items-center justify-center <?php echo e($navCartCount > 0 ? 'flex' : 'hidden'); ?>"><?php echo e($navCartCount > 99 ? '99+' : $navCartCount); ?></span>
                    </a>
                    <a href="<?php echo e(route('wishlist.index')); ?>" class="block px-4 py-3 rounded-lg hover:bg-gray-50 relative">
                        <i class="fas fa-heart mr-3 text-gray-400"></i>Danh sách yêu thích
                        <span id="wishlist-count-badge-mobile" class="wishlist-count absolute top-2 right-2 w-5 h-5 text-[10px] rounded-full bg-red-500 text-white flex items-center justify-center <?php echo e($navWishlistCount > 0 ? 'flex' : 'hidden'); ?>"><?php echo e($navWishlistCount > 99 ? '99+' : $navWishlistCount); ?></span>
                    </a>
                    <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('notifications.index')); ?>" class="block px-4 py-3 rounded-lg hover:bg-gray-50 relative">
                        <i class="fas fa-bell mr-3 text-gray-400"></i>Thông báo
                        <span class="notification-count absolute top-2 right-2 w-5 h-5 text-[10px] rounded-full bg-amber-500 text-white items-center justify-center <?php echo e($navUnreadNotifCount ? 'flex' : 'hidden'); ?>"><?php echo e($navUnreadNotifCount > 99 ? '99+' : $navUnreadNotifCount); ?></span>
                    </a>
                    <?php endif; ?>
                </div>
                ...
                <div class="pt-4 mt-2 border-t">
                    <?php if(auth()->guard()->check()): ?>
                    <div class="px-4 pb-2 text-sm text-gray-600">Xin chào, <span class="font-semibold text-gray-900"><?php echo e(optional(auth()->user()->userProfile)->name ?? 'Khách'); ?></span></div>
                    <?php if(auth()->user()->isStaff()): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-4 py-3 rounded-lg hover:bg-gray-50 flex items-center gap-2">
                        <span class="inline-flex items-center justify-center w-5"><i class="fas fa-briefcase text-gray-500 text-[14px]"></i></span>
                        <span class="flex-1">Khu vực làm việc</span>
                    </a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('user.profile.index')); ?>" class="block px-4 py-3 rounded-lg hover:bg-gray-50 flex items-center gap-2">
                        <span class="inline-flex items-center justify-center w-5"><i class="fas fa-user text-gray-500 text-[14px]"></i></span>
                        <span class="flex-1">Tài khoản</span>
                    </a>
                    <a href="<?php echo e(route('user.order.index')); ?>" class="block px-4 py-3 rounded-lg hover:bg-gray-50 flex items-center gap-2">
                        <span class="inline-flex items-center justify-center w-5"><i class="fas fa-file-invoice text-gray-500 text-[14px]"></i></span>
                        <span class="flex-1">Đơn hàng</span>
                    </a>
                    <a href="<?php echo e(route('user.service-appointments.index')); ?>" class="block px-4 py-3 rounded-lg hover:bg-gray-50 flex items-center gap-2">
                        <span class="inline-flex items-center justify-center w-5"><i class="fas fa-tools text-gray-500 text-[14px]"></i></span>
                        <span class="flex-1">Bảo dưỡng</span>
                    </a>
                    <a href="<?php echo e(route('test-drives.index')); ?>" class="block px-4 py-3 rounded-lg hover:bg-gray-50 flex items-center gap-2">
                        <span class="inline-flex items-center justify-center w-5"><i class="fas fa-car-side text-gray-500 text-[14px]"></i></span>
                        <span class="flex-1">Lái thử</span>
                    </a>
                    ...
                    <?php else: ?>
                    <a href="<?php echo e(route('login', ['redirect' => request()->fullUrl()])); ?>" class="block px-4 py-3 rounded-lg hover:bg-gray-50 flex items-center gap-2">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="block px-4 py-3 rounded-lg hover:bg-gray-50 flex items-center gap-2">
...
<script>
    ...
    window.refreshNotifBadge = async function(){
        <?php if(auth()->guard()->check()): ?>
        try{
            const res = await fetch(`<?php echo e(route('notifications.unread-count')); ?>?t=${Date.now()}`, { 
    ...
    window.refreshNotifList = async function(){
        try{
            const res = await fetch(`<?php echo e(route('notifications.index')); ?>`, { headers: { 'X-Requested-With':'XMLHttpRequest' } });
            const data = await res.json().catch(()=>({}));
    ...
    document.addEventListener('click', async function(e){
        ...
        try {
            const res = await fetch(`<?php echo e(route('notifications.read-all')); ?>`, {
                method: 'POST',
                headers: {
    ...
    <?php endif; ?>
</script><?php /**PATH C:\Users\forev\showroom-car-modern\resources\views/components/nav.blade.php ENDPATH**/ ?>
            ...
            <div id="nav-actions" class="flex items-center gap-1 sm:gap-2 shrink-0 h-16">
                ...
                <div class="dropdown-group notif-dropdown lg:hidden" data-dropdown="notifications-mobile">
                    <button class="relative inline-flex items-center justify-center w-10 h-10 rounded-full text-gray-600 hover:bg-amber-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500" data-dropdown-trigger>
                        ...
                        <span id="notif-count-badge-mobile" class="absolute -top-1 -right-1 w-5 h-5 text-[10px] rounded-full bg-amber-500 text-white items-center justify-center <?php echo e($navUnreadNotifCount ? 'flex' : 'hidden'); ?>"><?php echo e($navUnreadNotifCount > 99 ? '99+' : $navUnreadNotifCount); ?></span>
                ...
                <div class="dropdown-group notif-dropdown hidden lg:block" data-dropdown="notifications">
                    <button class="relative inline-flex items-center justify-center w-10 h-10 rounded-full text-gray-600 hover:bg-amber-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500" data-dropdown-trigger>
                        <i class="fas fa-bell"></i>
                        <span id="notif-count-badge" class="absolute -top-1 -right-1 w-5 h-5 text-[10px] rounded-full bg-amber-500 text-white items-center justify-center <?php echo e($navUnreadNotifCount ? 'flex' : 'hidden'); ?>"><?php echo e($navUnreadNotifCount > 99 ? '99+' : $navUnreadNotifCount); ?></span>
                        <span class="sr-only">Thông báo</span>
                    </button>
                    <div class="dropdown-bridge"></div>
            ...
            <div class="p-4 space-y-2">
                ...
                <div class="pt-4 mt-2 border-t">
                    ...
                    <a href="<?php echo e(route('notifications.index')); ?>" class="block px-4 py-3 rounded-lg hover:bg-gray-50 relative">
                        ...
                        <span class="absolute top-2 right-2 w-5 h-5 text-[10px] rounded-full bg-amber-500 text-white items-center justify-center <?php echo e($navUnreadNotifCount ? 'flex' : 'hidden'); ?>"><?php echo e($navUnreadNotifCount > 99 ? '99+' : $navUnreadNotifCount); ?></span>
                    </a>
                    <?php endif; ?>
                </div>
...
<script>
    ...
    window.refreshNotifBadge = async function(){
        <?php if(auth()->guard()->check()): ?>
        try{
            const res = await fetch(`<?php echo e(route('notifications.unread-count')); ?>`, { headers: { 'X-Requested-With':'XMLHttpRequest' } });

<?php $__env->startSection('title', 'Chỉnh sửa phụ kiện'); ?>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 max-w-7xl mx-auto">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-xl font-semibold text-gray-900">
                    ...
                    Chỉnh sửa phụ kiện: <?php echo e($accessory->name); ?>

                </h1>
                <p class="text-sm text-gray-600 mt-1">Chỉnh sửa thông tin phụ kiện xe hơi với đầy đủ thông tin</p>
            </div>
            <a href="<?php echo e(route('admin.accessories.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white text-sm font-medium rounded-lg transition-colors">
    ...
    <form id="accessoryEditForm" action="<?php echo e(route('admin.accessories.update', $accessory->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" 
                                   ...
                                   value="<?php echo e(old('name', $accessory->name)); ?>" placeholder="Ví dụ: Lót sàn, Phim cách nhiệt...">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="sku" id="sku" 
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                   value="<?php echo e(old('sku', $accessory->sku)); ?>" placeholder="ACC-001">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="category" id="category" 
                                ...
                                <option value="interior" <?php echo e(old('category', $accessory->category) == 'interior' ? 'selected' : ''); ?>>Nội thất</option>
                                <option value="exterior" <?php echo e(old('category', $accessory->category) == 'exterior' ? 'selected' : ''); ?>>Ngoại thất</option>
                                <option value="electronics" <?php echo e(old('category', $accessory->category) == 'electronics' ? 'selected' : ''); ?>>Điện tử</option>
                                <option value="performance" <?php echo e(old('category', $accessory->category) == 'performance' ? 'selected' : ''); ?>>Hiệu suất</option>
                                <option value="safety" <?php echo e(old('category', $accessory->category) == 'safety' ? 'selected' : ''); ?>>An toàn</option>
                                <option value="maintenance" <?php echo e(old('category', $accessory->category) == 'maintenance' ? 'selected' : ''); ?>>Bảo dưỡng</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="subcategory" id="subcategory" 
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                   value="<?php echo e(old('subcategory', $accessory->subcategory)); ?>" placeholder="Ví dụ: Thảm lót sàn">
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="short_description" id="short_description" rows="3" 
                                      class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                      placeholder="Mô tả ngắn gọn về phụ kiện..."><?php echo e(old('short_description', $accessory->short_description)); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="6" 
                                      class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                      placeholder="Mô tả chi tiết về phụ kiện, tính năng, lợi ích..."><?php echo e(old('description', $accessory->description)); ?></textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="number" name="weight" id="weight" step="0.01"
                                       class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                       value="<?php echo e(old('weight', $accessory->weight)); ?>" placeholder="0.5">
                            </div>
                            <div>
                                <label for="dimensions" class="block text-sm font-medium text-gray-700 mb-2">Kích thước</label>
                                <input type="text" name="dimensions" id="dimensions" 
                                       class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                       value="<?php echo e(old('dimensions', $accessory->dimensions)); ?>" placeholder="L x W x H">
                            </div>
                            <div>
                                <label for="material" class="block text-sm font-medium text-gray-700 mb-2">Chất liệu</label>
                                <input type="text" name="material" id="material" 
                                       class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                       value="<?php echo e(old('material', $accessory->material)); ?>" placeholder="Nhựa, Da, Kim loại...">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="base_price" id="base_price" 
                                           ...
                                           value="<?php echo e(old('base_price', number_format($accessory->base_price ?? 0, 0, '.', ''))); ?>" placeholder="0" onchange="updateCurrentPriceFromBase()">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="current_price" id="current_price" 
                                           class="block w-full px-3 py-2 pr-12 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                           value="<?php echo e(old('current_price', number_format($accessory->current_price ?? 0, 0, '.', ''))); ?>" placeholder="0">
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                        <span class="text-gray-500 sm:text-sm">VNĐ</span>
                                    </div>
                                </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="checkbox" name="is_on_sale" id="is_on_sale" value="1" 
                                   ...
                                   <?php echo e(old('is_on_sale', $accessory->is_on_sale) ? 'checked' : ''); ?>>
                            <label for="is_on_sale" class="ml-2 block text-sm text-gray-900">
                                Đang khuyến mãi
                            </label>
                        </div>

                        <div id="sale-dates" class="grid grid-cols-2 gap-4" style="display: <?php echo e(old('is_on_sale', $accessory->is_on_sale) ? 'grid' : 'none'); ?>">
                            <div>
                                ...
                                <input type="date" name="sale_start_date" id="sale_start_date" 
                                       class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                       value="<?php echo e(old('sale_start_date', $accessory->sale_start_date ? $accessory->sale_start_date->format('Y-m-d') : '')); ?>">
                            </div>
                            <div>
                                ...
                                <input type="date" name="sale_end_date" id="sale_end_date" 
                                       class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                       value="<?php echo e(old('sale_end_date', $accessory->sale_end_date ? $accessory->sale_end_date->format('Y-m-d') : '')); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="checkbox" name="installation_service_available" id="installation_service_available" value="1" 
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" 
                                   <?php echo e(old('installation_service_available', $accessory->installation_service_available) ? 'checked' : ''); ?>>
                            <label for="installation_service_available" class="ml-2 block text-sm text-gray-900">
                                Có dịch vụ lắp đặt
                            </label>
                        </div>

                        <div id="installation-details" style="display: <?php echo e(old('installation_service_available', $accessory->installation_service_available) ? 'block' : 'none'); ?>">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="number" name="installation_fee" id="installation_fee" 
                                               class="block w-full px-3 py-2 pr-12 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                               value="<?php echo e(old('installation_fee', $accessory->installation_fee ? intval($accessory->installation_fee) : '')); ?>" placeholder="0">
                                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                            <span class="text-gray-500 sm:text-sm">VNĐ</span>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="installation_time_minutes" id="installation_time_minutes" 
                                           class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                           value="<?php echo e(old('installation_time_minutes', $accessory->installation_time_minutes)); ?>" placeholder="30">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="installation_requirements" id="installation_requirements" rows="3" 
                                          class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                          placeholder="Yêu cầu đặc biệt khi lắp đặt..."><?php echo e(old('installation_requirements', $accessory->installation_requirements)); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="stock_quantity" id="stock_quantity" 
                                       class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                       value="<?php echo e(old('stock_quantity', $accessory->stock_quantity)); ?>" placeholder="Nhập số lượng tồn kho" min="1">
                            </div>
                            <div>
                                <label for="stock_status" class="block text-sm font-medium text-gray-700 mb-2">Trạng thái kho</label>
                                <select name="stock_status" id="stock_status" 
                                        class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    <option value="in_stock" <?php echo e(old('stock_status', $accessory->stock_status) == 'in_stock' ? 'selected' : ''); ?>>Còn hàng</option>
                                    <option value="low_stock" <?php echo e(old('stock_status', $accessory->stock_status) == 'low_stock' ? 'selected' : ''); ?>>Sắp hết hàng</option>
                                    <option value="out_of_stock" <?php echo e(old('stock_status', $accessory->stock_status) == 'out_of_stock' ? 'selected' : ''); ?>>Hết hàng</option>
                                    <option value="discontinued" <?php echo e(old('stock_status', $accessory->stock_status) == 'discontinued' ? 'selected' : ''); ?>>Ngừng kinh doanh</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="hidden" name="color_options" id="color_options_hidden" value="<?php echo e(old('color_options', json_encode($accessory->color_options ?? []))); ?>">
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="warranty_months" id="warranty_months" 
                                       class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                       value="<?php echo e(old('warranty_months', $accessory->warranty_months)); ?>" placeholder="12" min="0">
                            </div>
                            <div>
                                ...
                                <input type="number" name="return_policy_days" id="return_policy_days" 
                                       class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                       value="<?php echo e(old('return_policy_days', $accessory->return_policy_days)); ?>" placeholder="30" min="0">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="warranty_terms" id="warranty_terms" rows="4" 
                                      class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                      placeholder="Điều kiện và điều khoản bảo hành..."><?php echo e(old('warranty_terms', $accessory->warranty_terms)); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="hidden" name="compatible_car_brands" id="compatible_car_brands_hidden" value="<?php echo e(old('compatible_car_brands', json_encode($accessory->compatible_car_brands ?? []))); ?>">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="hidden" name="compatible_car_models" id="compatible_car_models_hidden" value="<?php echo e(old('compatible_car_models', json_encode($accessory->compatible_car_models ?? []))); ?>">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="hidden" name="compatible_car_years" id="compatible_car_years_hidden" value="<?php echo e(old('compatible_car_years', json_encode($accessory->compatible_car_years ?? []))); ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="specifications-tab" class="tab-content hidden">
                <div class="space-y-6">
                    ...
                    <input type="hidden" name="specifications" id="specifications_hidden" value="<?php echo e(old('specifications', json_encode($accessory->specifications ?? []))); ?>">
                </div>
            </div>
            ...
            <div id="features-tab" class="tab-content hidden">
                <div class="space-y-6">
                    ...
                    <input type="hidden" name="features" id="features_hidden" value="<?php echo e(old('features', json_encode($accessory->features ?? []))); ?>">
                </div>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div id="gallery-container" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <?php $__currentLoopData = $gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white p-3 rounded-lg border border-gray-200 relative image-card" data-image-index="<?php echo e($index); ?>">
                                
                                <div class="absolute top-2 right-2 z-10 flex gap-2">
                                    <button type="button" 
                                            class="edit-image-btn bg-blue-500 hover:bg-blue-600 text-white p-2 rounded-full shadow-lg transition-colors"
                                            data-index="<?php echo e($index); ?>"
                                            data-accessory-id="<?php echo e($accessory->id); ?>"
                                            title="Sửa ảnh">
                                ...
                                <div class="aspect-video bg-gray-100 rounded-lg overflow-hidden mb-3 relative">
                                    <?php if(is_string($image)): ?>
                                        ...
                                        <img src="<?php echo e($image); ?>" alt="Seeder Image <?php echo e($index + 1); ?>" 
                                    ...
                                    <?php elseif(is_array($image) || is_object($image)): ?>
                                        
                                        <?php $imageData = (array) $image; ?>
                                        <?php
                                            $imageUrl = '';
                                        ...
                                        <img src="<?php echo e($imageUrl); ?>" 
                                             alt="<?php echo e(is_string($imageData['alt_text'] ?? null) ? $imageData['alt_text'] : (is_string($imageData['alt'] ?? null) ? $imageData['alt'] : 'Gallery Image')); ?>" 
                                             class="w-full h-full object-cover"
                                             onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                        <!-- DEBUG: Image URL = <?php echo e($imageUrl); ?> -->
                                        <div class="w-full h-full bg-gradient-to-br from-gray-400 to-gray-600 flex items-center justify-center text-white font-semibold" style="display: none;">
                                            <i class="fas fa-image text-2xl"></i>
                                        </div>
                                        
                                        
                                        <?php if(isset($imageData['is_primary']) && $imageData['is_primary']): ?>
                                ...
                                <div class="space-y-1">
                                    <?php if(is_string($image)): ?>
                                        ...
                                        <div class="flex items-center gap-2 mb-2">
                                            <span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-blue-100 text-blue-800">
                                                <?php echo e($imageTypeVi); ?>

                                            </span>
                                        </div>
                                        <p class="text-sm font-medium text-gray-800 mb-1">Hình ảnh <?php echo e($index + 1); ?></p>
                                    ...
                                    <?php elseif(is_array($image) || is_object($image)): ?>
                                        ...
                                        <p class="text-sm font-medium text-gray-800 mb-1">
                                            <?php echo e(is_string($imageData['title'] ?? null) ? $imageData['title'] : "Hình ảnh " . ($index + 1)); ?>

                                        </p>
                                        <div class="text-xs text-gray-600 space-y-1">
                                            <div><?php echo e(is_string($imageData['alt_text'] ?? null) ? $imageData['alt_text'] : (is_string($imageData['alt'] ?? null) ? $imageData['alt'] : 'Không có alt text')); ?></div>
                                            <?php if(isset($imageData['description']) && !empty($imageData['description'])): ?>
                                            <div class="text-gray-500 italic"><?php echo e($imageData['description']); ?></div>
                                            <?php endif; ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="slug" id="slug" 
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                   value="<?php echo e(old('slug', $accessory->slug)); ?>" placeholder="phu-kien-xe-hoi">
                        ...
                        <div>
                            ...
                            <input type="text" name="meta_title" id="meta_title" 
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                   value="<?php echo e(old('meta_title', $accessory->meta_title)); ?>" placeholder="Tiêu đề trang cho SEO">
                        ...
                        <div>
                            ...
                            <textarea name="meta_description" id="meta_description" rows="3" 
                                      class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                      placeholder="Mô tả trang cho SEO..."><?php echo e(old('meta_description', $accessory->meta_description)); ?></textarea>
                        ...
                        <div>
                            ...
                            <input type="text" name="meta_keywords" id="meta_keywords" 
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                   value="<?php echo e(old('meta_keywords', $accessory->meta_keywords)); ?>" placeholder="từ khóa 1, từ khóa 2, từ khóa 3">
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center">
                                ...
                                <input type="checkbox" name="is_featured" id="is_featured" value="1" 
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" 
                                       <?php echo e(old('is_featured', $accessory->is_featured) ? 'checked' : ''); ?>>
                            ...
                            <div class="flex items-center">
                                ...
                                <input type="checkbox" name="is_bestseller" id="is_bestseller" value="1" 
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" 
                                       <?php echo e(old('is_bestseller', $accessory->is_bestseller) ? 'checked' : ''); ?>>
                            ...
                            <div class="flex items-center">
                                ...
                                <input type="checkbox" name="is_new_arrival" id="is_new_arrival" value="1" 
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" 
                                       <?php echo e(old('is_new_arrival', $accessory->is_new_arrival) ? 'checked' : ''); ?>>
                        ...
                        <div>
                            ...
                            <input type="number" name="sort_order" id="sort_order" 
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                   value="<?php echo e(old('sort_order', $accessory->sort_order ?? 0)); ?>" placeholder="0" min="0">
        ...
        <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
            <div class="flex items-center justify-between gap-4">
                <a href="<?php echo e(route('admin.accessories.index')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
...
let specsCount = <?php echo json_encode(is_array($accessory->specifications) ? count($accessory->specifications) : 0); ?>;
let featuresCount = <?php echo json_encode(is_array($accessory->features) ? count($accessory->features) : 0); ?>;
...
function populateExistingData() {
    ...
    const existingData = {
        colorOptions: <?php echo json_encode($accessory->color_options ?? '[]'); ?>,
        compatibleBrands: <?php echo json_encode($accessory->compatible_car_brands ?? '[]'); ?>,
        compatibleModels: <?php echo json_encode($accessory->compatible_car_models ?? '[]'); ?>,
        compatibleYears: <?php echo json_encode($accessory->compatible_car_years ?? '[]'); ?>,
        specifications: <?php echo json_encode($accessory->specifications ?? '[]'); ?>,
        features: <?php echo json_encode($accessory->features ?? '[]'); ?>
        ...
        form.addEventListener('submit', function(e) {
            ...
            .then(data => {
                if (data && data.success) {
                    ...
                    setTimeout(() => {
                        window.location.href = '<?php echo e(route("admin.accessories.index")); ?>';
                    }, 2000); // 2 second delay
                } else {
...
function generateSmartMetadata(file, index) {
    const accessoryName = '<?php echo e($accessory->name); ?>';
...
function convertNewImagesToSaved() {
    const accessoryId = '<?php echo e($accessory->id); ?>';
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.delete-modal','data' => ['modalId' => 'deleteImageModal','title' => 'Xác nhận xóa hình ảnh','deleteCallbackName' => 'confirmDeleteImage']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['modal-id' => 'deleteImageModal','title' => 'Xác nhận xóa hình ảnh','delete-callback-name' => 'confirmDeleteImage']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\forev\showroom-car-modern\resources\views/admin/accessories/edit.blade.php ENDPATH**/ ?>
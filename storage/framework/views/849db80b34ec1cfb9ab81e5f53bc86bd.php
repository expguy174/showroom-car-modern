    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
        <div class="flex items-center justify-between">
            <div class="flex-1">
                ...
                <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e(format_currency_short($salesData['current_month_sales'])); ?></p>
                <div class="flex items-center mt-2">
                    <?php if($salesData['sales_growth'] > 0): ?>
                        <i class="fas fa-arrow-up text-green-500 text-xs mr-1"></i>
                        <span class="text-green-600 text-xs font-medium">+<?php echo e(format_percentage($salesData['sales_growth'])); ?></span>
                    <?php elseif($salesData['sales_growth'] < 0): ?>
                        <i class="fas fa-arrow-down text-red-500 text-xs mr-1"></i>
                        <span class="text-red-600 text-xs font-medium"><?php echo e(format_percentage($salesData['sales_growth'])); ?></span>
                    <?php else: ?>
            ...
            <div class="flex-1">
                ...
                <div class="flex items-center mt-2">
                    <?php if(($customerData['customer_growth'] ?? 0) > 0): ?>
                        <i class="fas fa-arrow-up text-green-500 text-xs mr-1"></i>
                        <span class="text-green-600 text-xs font-medium">+<?php echo e(format_percentage($customerData['customer_growth'])); ?></span>
                    <?php elseif(($customerData['customer_growth'] ?? 0) < 0): ?>
                        <i class="fas fa-arrow-down text-red-500 text-xs mr-1"></i>
                        <span class="text-red-600 text-xs font-medium"><?php echo e(format_percentage($customerData['customer_growth'])); ?></span>
                    <?php else: ?>
                        <i class="fas fa-minus text-gray-400 text-xs mr-1"></i>
                        <span class="text-gray-500 text-xs">Không đổi</span>
                    <?php endif; ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
        <div class="flex items-center justify-between">
            <div class="flex-1">
                ...
                <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e(format_percentage($performanceData['conversion_rate'] ?? 0)); ?></p>
                <div class="flex items-center mt-2">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
        <div class="flex items-center justify-between">
            <div class="flex-1">
                ...
                <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e(format_currency_short($performanceData['average_order_value'] ?? 0)); ?></p>
                <div class="flex items-center mt-2">

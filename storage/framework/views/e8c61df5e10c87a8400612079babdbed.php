<?php $__env->startSection('title', 'Thêm showroom'); ?>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 max-w-7xl mx-auto">
    ...
    <form id="showroomForm" action="<?php echo e(route('admin.showrooms.store')); ?>" method="POST" class="p-6">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4"
                                class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Nhập mô tả về showroom..."><?php echo e(old('description')); ?></textarea>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\forev\showroom-car-modern\resources\views/admin/showrooms/create.blade.php ENDPATH**/ ?>
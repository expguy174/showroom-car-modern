...
<?php endif; ?>
        ...
        <div class="mt-3 flex items-center gap-2 flex-wrap">
            ...
            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                <?php echo e(['pending' => 'Chờ thanh toán', 'processing' => 'Đang xử lý', 'completed' => 'Đã thanh toán', 'failed' => 'Thất bại', 'cancelled' => 'Đã hủy'][request('payment_status')] ?? request('payment_status')); ?>

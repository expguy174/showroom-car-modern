<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
    <div class="overflow-x-auto">
        ...
        <thead class="bg-gray-50">
            <tr>
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase whitespace-nowrap" style="width: 25%;">Showroom</th>
        ...
        <tbody class="divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50" data-showroom-id="<?php echo e($showroom->id); ?>">
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm font-medium text-gray-900 truncate"><?php echo e($showroom->name); ?></div>
                    <div class="text-xs text-gray-500 truncate"><?php echo e($showroom->code); ?></div>
                    <?php if($showroom->description): ?>
                    <div class="text-xs text-gray-400 truncate"><?php echo e(Str::limit($showroom->description, 50)); ?></div>
                    <?php endif; ?>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-gray-900 truncate"><i class="fas fa-map-marker-alt text-blue-600 mr-1"></i><?php echo e($showroom->city); ?></div>
                    <div class="text-xs text-gray-500 truncate"><?php echo e(Str::limit($showroom->address, 35)); ?></div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-gray-900 truncate"><i class="fas fa-phone text-green-600 mr-1"></i><?php echo e($showroom->phone); ?></div>
                    <?php if($showroom->email): ?>
                    <div class="text-xs text-gray-500 truncate"><i class="fas fa-envelope text-gray-400 mr-1"></i><?php echo e($showroom->email); ?></div>
                    <?php endif; ?>
                </td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.table-actions','data' => ['item' => $showroom,'editRoute' => 'admin.showrooms.edit','deleteRoute' => 'admin.showrooms.destroy','hasToggle' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['item' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($showroom),'editRoute' => 'admin.showrooms.edit','deleteRoute' => 'admin.showrooms.destroy','hasToggle' => true]); ?>
            ...
            <tr>
                <td colspan="5" class="px-6 py-12 text-center">
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <p class="text-gray-500 text-lg font-medium">Không tìm thấy showroom nào</p>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.pagination','data' => ['paginator' => $showrooms]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['paginator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($showrooms)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\Users\forev\showroom-car-modern\resources\views/admin/showrooms/partials/table.blade.php ENDPATH**/ ?>
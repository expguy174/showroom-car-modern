                            ...
                            <?php if($order->user): ?>
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div class="flex-shrink-0">
                                        <?php if($order->user->userProfile && $order->user->userProfile->avatar_path): ?>
                                        ...
                                        <?php else: ?>
                                            <div class="h-10 w-10 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center">
                                                <span class="text-white font-semibold text-sm">
                                                    <?php echo e(strtoupper(mb_substr($order->user->userProfile->name ?? $order->user->email, 0, 2, 'UTF-8'))); ?>

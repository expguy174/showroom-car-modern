                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div class="space-y-3 text-sm">
                                    ...
                                    <?php $__currentLoopData = $cartItems->sortBy(function($item) { return $item->item_type === 'car_variant' ? 0 : 1; }); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ci): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="flex justify-between text-gray-600 text-sm product-summary-item">
                                            <span class="truncate"><?php echo e($itemName); ?> x<?php echo e($ci->quantity); ?></span>
                                            <span class="font-semibold text-gray-900"><?php echo e(number_format($itemTotal, 0, ',', '.')); ?> đ</span>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="flex justify-between text-gray-600 text-sm">
                                        <span>Tạm tính</span>
                                        <span class="font-semibold text-gray-900"><span id="subtotal"><?php echo e(number_format($subtotal, 0, ',', '.')); ?></span> đ</span>
                                    </div>
                                    
                                    <!-- Tax -->
                                    <div class="flex justify-between text-gray-600 text-sm">
                                        <span>Thuế VAT (10%)</span>
                                        <span class="font-semibold text-gray-900"><span id="tax-total"><?php echo e(number_format($taxTotal, 0, ',', '.')); ?></span> đ</span>
                                    </div>
                                ...
                                <div class="border-t border-gray-200 pt-4">
                                    <div class="flex justify-between items-center">
                                        ...
                                        <span class="text-xl font-bold text-blue-600"><span id="cart-total"><?php echo e(number_format($subtotal + $taxTotal, 0, ',', '.')); ?></span> đ</span>
                                    </div>
                                </div>

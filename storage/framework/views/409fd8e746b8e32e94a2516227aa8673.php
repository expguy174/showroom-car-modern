<?php $__env->startSection('title', 'Giỏ hàng - Showroom Ô tô'); ?>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center space-x-4">
                    <a href="<?php echo e(route('products.index')); ?>" class="flex items-center text-blue-600 hover:text-blue-700 font-medium">
        ...
        <template id="cart-empty-template">
            <div class="text-center py-16">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="<?php echo e(route('products.index', ['type' => 'car'])); ?>" 
                ...
                <div class="lg:col-span-8 xl:col-span-9 space-y-6">
                            ...
                            <div class="overflow-x-auto">
                                <table id="car-table" class="cart-table centered min-w-full">
                                    ...
                                    <tbody class="divide-y divide-gray-100">
                                        <?php $__currentLoopData = $carItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php echo $__env->make('user.cart.partials.car-item', ['item' => $item], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        ...
                        <div class="p-0">
                            <div class="overflow-x-auto">
                                <table id="accessory-table" class="cart-table centered min-w-full">
                                    ...
                                    <tbody class="divide-y divide-gray-100">
                                        <?php $__currentLoopData = $accessoryItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php echo $__env->make('user.cart.partials.accessory-item', ['item' => $item], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                        <button type="button" id="clear-cart-btn" 
                                ...
                                data-url="<?php echo e(route('user.cart.clear')); ?>" data-csrf="<?php echo e(csrf_token()); ?>">
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div class="space-y-3 text-sm">
                                    ...
                                    <?php $__currentLoopData = $cartItems->sortBy(function($item) { return $item->item_type === 'car_variant' ? 0 : 1; }); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ci): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="flex justify-between items-center gap-2 text-gray-600 text-sm product-summary-item">
                                            <span class="truncate cursor-help" title="<?php echo e($itemName); ?> (x<?php echo e($ci->quantity); ?>)"><?php echo e($itemName); ?> x<?php echo e($ci->quantity); ?></span>
                                            <span class="font-semibold text-gray-900 whitespace-nowrap text-right"><?php echo e(number_format($itemTotal, 0, ',', '.')); ?> đ</span>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="flex justify-between items-center gap-2 text-gray-600 text-sm">
                                        ...
                                        <span class="font-semibold text-gray-900 whitespace-nowrap text-right"><span id="subtotal"><?php echo e(number_format($subtotal, 0, ',', '.')); ?></span> đ</span>
                                    </div>
                                    
                                    <!-- Tax -->
                                    <div class="flex justify-between items-center gap-2 text-gray-600 text-sm">
                                        <span class="whitespace-nowrap">Thuế VAT (10%)</span>
                                        <span class="font-semibold text-gray-900 whitespace-nowrap text-right"><span id="tax-total"><?php echo e(number_format($taxTotal, 0, ',', '.')); ?></span> đ</span>
                                    </div>
                                ...
                                <div class="border-t border-gray-200 pt-4">
                                    <div class="flex justify-between items-center gap-2">
                                        ...
                                        <span class="text-base sm:text-lg font-bold text-blue-600 text-right truncate cursor-help" title="<?php echo e(number_format($subtotal + $taxTotal, 0, ',', '.')); ?> đ"><span id="cart-total"><?php echo e(number_format($subtotal + $taxTotal, 0, ',', '.')); ?></span> đ</span>
                                    </div>
                                </div>

                                <!-- Checkout Button -->
                                <a href="<?php echo e(route('user.cart.checkout.form')); ?>" class="block w-full">
...
(function(){
  ...
  document.addEventListener('DOMContentLoaded', function(){
    const checkoutLink = document.querySelector(`a[href='<?php echo e(route('user.cart.checkout.form')); ?>']`);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\forev\showroom-car-modern\resources\views/user/cart/index.blade.php ENDPATH**/ ?>
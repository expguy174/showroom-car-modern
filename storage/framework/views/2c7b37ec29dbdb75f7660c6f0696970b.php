...
<?php $__env->startSection('title', 'Chỉnh sửa phiên bản xe'); ?>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 max-w-7xl mx-auto">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-xl font-semibold text-gray-900">
                    ...
                    Cập nhật phiên bản xe: <?php echo e($carvariant->name); ?>

                </h1>
                <p class="text-sm text-gray-600 mt-1">Quản lý đầy đủ thông tin phiên bản xe</p>
            </div>
            <a href="<?php echo e(route('admin.carvariants.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white text-sm font-medium rounded-lg transition-colors">
    ...
    <div class="border-b border-gray-200">
        <nav class="flex flex-wrap gap-x-4 gap-y-2 px-6" aria-label="Tabs">
            ...
            <button type="button" class="tab-button py-3 px-2 border-b-2 border-transparent font-medium text-sm text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap" data-tab="colors">
                ...
                <span class="hidden sm:inline">Màu</span> (<?php echo e($carvariant->colors->count()); ?>)
            </button>
            <button type="button" class="tab-button py-3 px-2 border-b-2 border-transparent font-medium text-sm text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap" data-tab="specifications">
                ...
                <span class="hidden sm:inline">Thông số</span> (<?php echo e($carvariant->specifications->count()); ?>)
            </button>
            <button type="button" class="tab-button py-3 px-2 border-b-2 border-transparent font-medium text-sm text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap" data-tab="features">
                ...
                <span class="hidden sm:inline">Tính năng</span> (<?php echo e($carvariant->featuresRelation->count()); ?>)
            </button>
            <button type="button" class="tab-button py-3 px-2 border-b-2 border-transparent font-medium text-sm text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap" data-tab="images">
                ...
                <span class="hidden sm:inline">Ảnh</span> (<?php echo e($carvariant->images->count()); ?>)
            </button>
        </nav>
    </div>
    ...
    <div class="p-6">
        ...
        <div id="basic-tab" class="tab-content">
            <form id="basicInfoForm" action="<?php echo e(route('admin.carvariants.update', $carvariant->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
>
                                        ...
                                        <?php $__currentLoopData = $carModels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($model->id); ?>" <?php echo e(old('car_model_id', $carvariant->car_model_id) == $model->id ? 'selected' : ''); ?>>
                                                <?php echo e($model->carBrand->name ?? 'Unknown'); ?> - <?php echo e($model->name); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" 
                                           class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                           value="<?php echo e(old('name', $carvariant->name)); ?>" placeholder="Ví dụ: 2.0 CVT, 1.5 Turbo RS...">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="sku" id="sku" 
                                           class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                           value="<?php echo e(old('sku', $carvariant->sku)); ?>" placeholder="Ví dụ: HRV-20CVT-2024">
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="description" id="description" rows="4" 
                                              class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                              placeholder="Mô tả chi tiết về phiên bản xe..."><?php echo e(old('description', $carvariant->description)); ?></textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="short_description" id="short_description" rows="2" 
                                              class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                              placeholder="Mô tả ngắn gọn cho hiển thị danh sách..."><?php echo e(old('short_description', $carvariant->short_description)); ?></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input type="number" name="base_price" id="base_price" 
                                                   ...
                                                   value="<?php echo e(old('base_price', number_format($carvariant->base_price, 0, '.', ''))); ?>" placeholder="0">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input type="number" name="current_price" id="current_price" 
                                                   class="block w-full px-3 py-2 pr-16 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                                   value="<?php echo e(old('current_price', number_format($carvariant->current_price, 0, '.', ''))); ?>" placeholder="0">
                                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                                <span class="text-gray-500 sm:text-sm">VNĐ</span>
                                            </div>
                                        </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <input type="checkbox" name="is_on_sale" id="is_on_sale" value="1" 
                                           ...
                                           <?php echo e(old('is_on_sale', $carvariant->is_on_sale) ? 'checked' : ''); ?>>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="meta_title" id="meta_title" 
                                           class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                           value="<?php echo e(old('meta_title', $carvariant->meta_title)); ?>" placeholder="Tiêu đề SEO...">
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="meta_description" id="meta_description" rows="3" 
                                              class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                              placeholder="Mô tả SEO..."><?php echo e(old('meta_description', $carvariant->meta_description)); ?></textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="keywords" id="keywords" 
                                           class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                           value="<?php echo e(old('keywords', $carvariant->keywords)); ?>" placeholder="từ khóa, phân cách, bằng dấu phẩy">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="flex items-center">
                                        ...
                                        <input type="checkbox" name="is_active" id="is_active" value="1" 
                                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" 
                                               <?php echo e(old('is_active', $carvariant->is_active) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <input type="checkbox" name="is_available" id="is_available" value="1" 
                                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" 
                                               <?php echo e(old('is_available', $carvariant->is_available) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <input type="checkbox" name="is_featured" id="is_featured" value="1" 
                                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" 
                                               <?php echo e(old('is_featured', $carvariant->is_featured) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <input type="checkbox" name="is_new_arrival" id="is_new_arrival" value="1" 
                                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" 
                                               <?php echo e(old('is_new_arrival', $carvariant->is_new_arrival) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <input type="checkbox" name="is_bestseller" id="is_bestseller" value="1" 
                                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" 
                                               <?php echo e(old('is_bestseller', $carvariant->is_bestseller) ? 'checked' : ''); ?>>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="sort_order" id="sort_order" 
                                           class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                           value="<?php echo e(old('sort_order', $carvariant->sort_order)); ?>" placeholder="0">
                                </div>
                            </div>
                        </div>
        ...
        <div id="colors-tab" class="tab-content hidden">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4" id="colorsContainer">
                ...
                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200" 
                     ...
                     data-color-type="<?php echo e($color->color_type); ?>"
                     data-availability="<?php echo e($color->availability); ?>"
                     data-price-adjustment="<?php echo e($color->price_adjustment); ?>"
                     data-description="<?php echo e($color->description); ?>"
                     data-sort-order="<?php echo e($color->sort_order ?? 0); ?>"
                     data-is-active="<?php echo e($color->is_active ? '1' : '0'); ?>"
                     data-is-free="<?php echo e($color->is_free ? '1' : '0'); ?>"
                     data-is-popular="<?php echo e($color->is_popular ? '1' : '0'); ?>">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center">
                            <?php if($color->hex_code): ?>
                                <div class="w-6 h-6 rounded-full border border-gray-300 mr-2" style="background-color: <?php echo e($color->hex_code); ?>;"></div>
                            <?php endif; ?>
                            <h4 class="font-medium text-gray-900"><?php echo e($color->color_name); ?></h4>
                        </div>
                        <button type="button" class="text-red-600 hover:text-red-800 delete-color" data-color-id="<?php echo e($color->id); ?>">
                    ...
                    <div class="space-y-2 text-sm text-gray-600 mb-4">
                        ...
                        <p><strong>Hex:</strong> 
                            <?php if($color->hex_code): ?>
                                <span class="font-mono text-sm"><?php echo e($color->hex_code); ?></span>
                            <?php else: ?>
                                <span class="text-gray-400 italic">Chưa có mã hex</span>
                            <?php endif; ?>
                        </p>
                        <p><strong>RGB:</strong> 
                            <?php if($color->rgb_code): ?>
                                <span class="font-mono text-sm"><?php echo e($color->rgb_code); ?></span>
                            <?php else: ?>
                                <span class="text-gray-400 italic">Chưa có mã RGB</span>
                            <?php endif; ?>
                        </p>
                        <p><strong>Loại:</strong> 
                            <?php switch($color->color_type):
                                case ('solid'): ?> Màu đặc <?php break; ?>
                                <?php case ('metallic'): ?> Màu kim loại <?php break; ?>
                                <?php case ('pearlescent'): ?> Màu ngọc trai <?php break; ?>
                                <?php case ('matte'): ?> Màu nhám <?php break; ?>
                                <?php case ('special'): ?> Màu đặc biệt <?php break; ?>
                                <?php default: ?> <?php echo e(ucfirst($color->color_type)); ?>

                            <?php endswitch; ?>
                        </p>
                        <p><strong>Tình trạng:</strong> 
                            <?php switch($color->availability):
                                case ('standard'): ?> Tiêu chuẩn <?php break; ?>
                                <?php case ('optional'): ?> Tùy chọn <?php break; ?>
                                <?php case ('limited'): ?> Giới hạn <?php break; ?>
                                <?php case ('discontinued'): ?> Ngừng sản xuất <?php break; ?>
                                <?php default: ?> <?php echo e(ucfirst($color->availability)); ?>

                            <?php endswitch; ?>
                        </p>
                        <p><strong>Phụ phí:</strong> <span class="text-blue-600 font-medium"><?php echo e($color->price_adjustment > 0 ? '+' : ''); ?><?php echo e(number_format($color->price_adjustment)); ?> VNĐ</span></p>
                        <p><strong>Mô tả:</strong> 
                            <?php if($color->description): ?>
                                <?php echo e($color->description); ?>
                    ...
                    <div class="border-t pt-4">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <div>
                                ...
                                <div class="w-full px-2 py-1 text-sm border border-gray-300 rounded bg-gray-50 text-gray-700 inventory-quantity-display"
                                     data-color-id="<?php echo e($color->id); ?>"><?php echo e($inventory['quantity']); ?></div>
                                <input type="hidden" name="color_inventory[<?php echo e($color->id); ?>][quantity]" value="<?php echo e($inventory['quantity']); ?>" class="inventory-quantity">
                            </div>
                            <div>
                                ...
                                <div class="w-full px-2 py-1 text-sm border border-gray-300 rounded bg-gray-50 text-gray-700 inventory-reserved-display"
                                     data-color-id="<?php echo e($color->id); ?>"><?php echo e($inventory['reserved']); ?></div>
                                <input type="hidden" name="color_inventory[<?php echo e($color->id); ?>][reserved]" value="<?php echo e($inventory['reserved']); ?>" class="inventory-reserved">
                            </div>
                            <div>
                                ...
                                <div class="w-full px-2 py-1 text-sm border border-gray-300 rounded bg-gray-50 text-gray-700 inventory-available-display"
                                     data-color-id="<?php echo e($color->id); ?>"><?php echo e($inventory['available']); ?></div>
                                <input type="hidden" name="color_inventory[<?php echo e($color->id); ?>][available]" value="<?php echo e($inventory['available']); ?>" class="inventory-available">
                            </div>
                        </div>
                        ...
                        <div class="mt-3 flex items-center justify-between">
                            <div class="flex items-center space-x-2">
                                <?php if($inventory['available'] > 10): ?>
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                        Còn hàng
                                    </span>
                                <?php elseif($inventory['available'] > 0): ?>
                                ...
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($color->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                    <?php echo e($color->is_active ? 'Hoạt động' : 'Tạm dừng'); ?>

                                </span>
                                
                                <?php if($color->is_free): ?>
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">Miễn phí</span>
                                <?php endif; ?>
                                
                                <?php if($color->is_popular): ?>
                            ...
                            <button type="button" class="text-blue-600 hover:text-blue-800 edit-color" data-color-id="<?php echo e($color->id); ?>">
        ...
        <div id="specifications-tab" class="tab-content hidden">
            ...
            <div class="space-y-6" id="specificationsContainer">
                ...
                <?php $__currentLoopData = $specCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $specs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-gray-50 rounded-lg p-4">
                    <h4 class="font-medium text-gray-900 mb-4">
                        <?php switch($category):
                            case ('engine'): ?> Động cơ <?php break; ?>
                            <?php case ('performance'): ?> Hiệu suất <?php break; ?>
                            <?php case ('dimensions'): ?> Kích thước <?php break; ?>
                            <?php case ('fuel'): ?> Nhiên liệu <?php break; ?>
                            <?php case ('transmission'): ?> Hộp số <?php break; ?>
                            <?php case ('brake'): ?> Phanh <?php break; ?>
                            <?php case ('chassis'): ?> Khung gầm <?php break; ?>
                            <?php case ('seating'): ?> Ghế ngồi <?php break; ?>
                            <?php case ('safety'): ?> An toàn <?php break; ?>
                            <?php case ('comfort'): ?> Tiện nghi <?php break; ?>
                            <?php case ('technology'): ?> Công nghệ <?php break; ?>
                            <?php case ('warranty'): ?> Bảo hành <?php break; ?>
                            <?php case ('wheels'): ?> Bánh xe <?php break; ?>
                            <?php default: ?> <?php echo e($category ?: 'Khác'); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="bg-white rounded-lg p-3 border border-gray-200" 
                             data-spec-id="<?php echo e($spec->id); ?>"
                             data-spec-name="<?php echo e($spec->spec_name); ?>"
                             data-spec-value="<?php echo e($spec->spec_value); ?>"
                             data-unit="<?php echo e($spec->unit); ?>"
                             data-category="<?php echo e($spec->category); ?>"
                             data-spec-code="<?php echo e($spec->spec_code); ?>"
                             data-description="<?php echo e($spec->description); ?>"
                             data-is-important="<?php echo e($spec->is_important ? '1' : '0'); ?>"
                             data-is-highlighted="<?php echo e($spec->is_highlighted ? '1' : '0'); ?>"
                             data-sort-order="<?php echo e($spec->sort_order ?? 0); ?>">
                            <div class="flex items-center justify-between">
                                <div class="flex-1">
                                    <div class="flex items-center gap-2">
                                        <p class="font-medium text-gray-900"><?php echo e($spec->spec_name); ?></p>
                                        <?php if($spec->spec_code): ?>
                                            <span class="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-mono bg-gray-100 text-gray-600">
                                                <?php echo e($spec->spec_code); ?>

                                            </span>
                                        <?php endif; ?>
                                    </div>
                                    <p class="text-sm text-gray-600">
                                        <?php echo e($spec->spec_value); ?><?php echo e($spec->unit ? ' ' . $spec->unit : ''); ?>

                                    </p>
                                    <?php if($spec->description): ?>
                                        <p class="text-xs text-gray-500 mt-1"><?php echo e($spec->description); ?></p>
                                    <?php endif; ?>
                                </div>
                                <div class="flex items-center space-x-2">
                                    <?php if($spec->is_important): ?>
                                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                            Quan trọng
                                        </span>
                                    <?php endif; ?>
                                    <?php if($spec->is_highlighted): ?>
                                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                            Nổi bật
                                        </span>
                                    <?php endif; ?>
                                    <button type="button" class="text-blue-600 hover:text-blue-800 edit-spec" data-spec-id="<?php echo e($spec->id); ?>">
                                        <i class="fas fa-edit text-sm"></i>
                                    </button>
                                    <button type="button" class="text-red-600 hover:text-red-800 delete-spec" data-spec-id="<?php echo e($spec->id); ?>">
                                        <i class="fas fa-trash text-sm"></i>
                                    </button>
                                </div>
                            </div>
        ...
        <div id="features-tab" class="tab-content hidden">
            ...
            <div class="space-y-6" id="featuresContainer">
                ...
                <?php $__currentLoopData = $featureCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $features): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-gray-50 rounded-lg p-4">
                    <h4 class="font-medium text-gray-900 mb-4">
                        <?php switch($category):
                            case ('safety'): ?> An toàn <?php break; ?>
                            <?php case ('comfort'): ?> Tiện nghi <?php break; ?>
                            <?php case ('technology'): ?> Công nghệ <?php break; ?>
                            <?php case ('performance'): ?> Hiệu suất <?php break; ?>
                            <?php case ('exterior'): ?> Ngoại thất <?php break; ?>
                            <?php case ('interior'): ?> Nội thất <?php break; ?>
                            <?php case ('entertainment'): ?> Giải trí <?php break; ?>
                            <?php case ('convenience'): ?> Tiện ích <?php break; ?>
                            <?php case ('wheels'): ?> Bánh xe <?php break; ?>
                            <?php case ('audio'): ?> Âm thanh <?php break; ?>
                            <?php case ('navigation'): ?> Định vị <?php break; ?>
                            <?php default: ?> <?php echo e($category ?: 'Khác'); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="bg-white rounded-lg p-3 border border-gray-200" 
                             ...
                             data-feature-name="<?php echo e($feature->feature_name); ?>"
                             data-description="<?php echo e($feature->description ?? ''); ?>"
                             data-feature-code="<?php echo e($feature->feature_code ?? ''); ?>"
                             data-category="<?php echo e($feature->category); ?>"
                             data-availability="<?php echo e($feature->availability); ?>"
                             data-importance="<?php echo e($feature->importance); ?>"
                             data-price="<?php echo e($feature->price ?? 0); ?>"
                             data-is-included="<?php echo e($feature->is_included ? '1' : '0'); ?>"
                             data-is-active="<?php echo e($feature->is_active ? '1' : '0'); ?>"
                             data-is-featured="<?php echo e($feature->is_featured ? '1' : '0'); ?>"
                             data-is-popular="<?php echo e($feature->is_popular ? '1' : '0'); ?>"
                             data-is-recommended="<?php echo e($feature->is_recommended ? '1' : '0'); ?>"
                             data-sort-order="<?php echo e($feature->sort_order ?? 0); ?>">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <div class="flex items-center gap-2">
                                        <?php if($feature->icon_path): ?>
                                            <i class="<?php echo e($feature->icon_path); ?> text-blue-600 mr-1"></i>
                                        <?php endif; ?>
                                        <p class="font-medium text-gray-900"><?php echo e($feature->feature_name); ?></p>
                                        <?php if($feature->feature_code): ?>
                                            <span class="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-mono bg-gray-100 text-gray-600">
                                                <?php echo e($feature->feature_code); ?>

                                            </span>
                                        <?php endif; ?>
                                    </div>
                                    <?php if($feature->description): ?>
                                        <p class="text-sm text-gray-600 mt-1"><?php echo e($feature->description); ?></p>
                                    <?php endif; ?>
                                    <?php if($feature->price > 0): ?>
                                        <p class="text-sm font-medium text-green-600 mt-1">
                                            +<?php echo e(number_format($feature->price, 0, ',', '.')); ?> VND
                                        </p>
                                    <?php endif; ?>
                                    <div class="flex flex-wrap items-center gap-1 mt-2">
                                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($feature->availability == 'standard' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                                            <?php echo e($feature->availability == 'standard' ? 'Tiêu chuẩn' : 'Tùy chọn'); ?>
                                        ...
                                        <?php endif; ?>
                                        <?php if($feature->is_recommended): ?>
                                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-800">
                                                Khuyến nghị
                                            </span>
                                        <?php endif; ?>
                                        <?php switch($feature->importance):
                                            case ('essential'): ?>
                                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                                    Thiết yếu
                                                </span>
                                ...
                                <div class="flex items-center space-x-2">
                                    <button type="button" class="text-blue-600 hover:text-blue-800 edit-feature" data-feature-id="<?php echo e($feature->id); ?>">
                                        <i class="fas fa-edit text-sm"></i>
                                    </button>
                                    <button type="button" class="text-red-600 hover:text-red-800 delete-feature" data-feature-id="<?php echo e($feature->id); ?>">
                                        <i class="fas fa-trash text-sm"></i>
                                    </button>
                                </div>
                            </div>
        ...
        <div id="images-tab" class="tab-content hidden">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4" id="imagesContainer">
                <?php $__currentLoopData = $carvariant->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="relative bg-gray-50 rounded-lg overflow-hidden border border-gray-200" 
                     data-image-id="<?php echo e($image->id); ?>"
                     data-image-url="<?php echo e($image->image_url); ?>"
                     data-alt-text="<?php echo e($image->alt_text); ?>"
                     data-title="<?php echo e($image->title); ?>"
                     data-image-type="<?php echo e($image->image_type); ?>"
                     data-angle="<?php echo e($image->angle); ?>"
                     data-description="<?php echo e($image->description); ?>"
                     data-sort-order="<?php echo e($image->sort_order); ?>"
                     data-is-main="<?php echo e($image->is_main ? '1' : '0'); ?>"
                     data-is-active="<?php echo e($image->is_active ? '1' : '0'); ?>"
                     data-color-id="<?php echo e($image->car_variant_color_id); ?>">
                    
                    
                    <div class="relative">
                        <img src="<?php echo e(str_starts_with($image->image_url, 'http') ? $image->image_url : asset('storage/' . $image->image_url)); ?>" 
                    ...
                    <div class="absolute top-2 right-2 flex space-x-1">
                        <button type="button" class="edit-image bg-white bg-opacity-80 hover:bg-opacity-100 text-blue-600 p-1 rounded" data-image-id="<?php echo e($image->id); ?>" title="Chỉnh sửa">
                            <i class="fas fa-edit text-xs"></i>
                        </button>
                        <button type="button" class="delete-image bg-red-500 bg-opacity-80 hover:bg-opacity-100 text-white p-1 rounded" data-image-id="<?php echo e($image->id); ?>" title="Xóa ảnh">
                    ...
                    <div class="p-2">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <?php if($image->angle): ?>
                                    <span class="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800">
                                        <?php switch($image->angle):
                                            case ('front'): ?> Trước <?php break; ?>
                                            <?php case ('side'): ?> Bên <?php break; ?>
                                            <?php case ('rear'): ?> Sau <?php break; ?>
                                            <?php case ('interior'): ?> Trong <?php break; ?>
                                            <?php case ('wheel'): ?> Bánh xe <?php break; ?>
                                            <?php case ('headlight'): ?> Đèn pha <?php break; ?>
                                            <?php case ('grille'): ?> Lưới tản nhiệt <?php break; ?>
                                            <?php case ('dashboard'): ?> Bảng điều khiển <?php break; ?>
                                            <?php case ('seats'): ?> Ghế ngồi <?php break; ?>
                                            <?php case ('console'): ?> Bảng điều khiển giữa <?php break; ?>
                                            <?php case ('trunk'): ?> Cốp xe <?php break; ?>
                                            <?php case ('steering'): ?> Vô lăng <?php break; ?>
                                            <?php case ('door'): ?> Cửa xe <?php break; ?>
                                            <?php default: ?> <?php echo e(ucfirst($image->angle)); ?>
                        ...
                        <?php endif; ?>
                        <?php if($image->car_variant_color_id): ?>
                            <?php
                                $linkedColor = $carvariant->colors->find($image->car_variant_color_id);
                            ?>
                            <?php if($linkedColor): ?>
                                <div class="flex items-center mt-1">
                                    <div class="w-3 h-3 rounded-full border border-gray-300 mr-1" style="background-color: <?php echo e($linkedColor->hex_code); ?>"></div>
                                    <span class="text-xs text-gray-500"><?php echo e($linkedColor->color_name); ?></span>
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
    ...
    <div class="border-t border-gray-200 px-6 py-4 mt-8">
        <div class="flex items-center justify-between">
            <a href="<?php echo e(route('admin.carvariants.index')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
    ...
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto px-6 py-6">
            <form id="uploadForm" class="space-y-4" enctype="multipart/form-data">
                <input type="hidden" name="car_variant_id" value="<?php echo e($carvariant->id); ?>">
...
const carVariantColors = <?php echo json_encode($carvariant->colors, 15, 512) ?>;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('basicInfoForm').addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (data.success) {
                ...
                setTimeout(() => {
                    window.location.href = '<?php echo e(route("admin.carvariants.index")); ?>';
                }, 2000); // 2 second delay
            } else {
    ...
    function showIndividualSettings(files) {
        ...
        files.forEach((file, index) => {
            ...
            const defaultTitle = `<?php echo e($carvariant->name); ?> - ${cleanFileName}`;
            
            // Smart alt text for SEO
            const defaultAlt = `Hình ảnh ${cleanFileName} của <?php echo e($carvariant->name); ?> <?php echo e($carvariant->carModel->carBrand->name); ?> - Ảnh ${index + 1}`;
            
            // Smart description
            const defaultDescription = `Ảnh chi tiết ${cleanFileName} của <?php echo e($carvariant->name); ?>, thể hiện đầy đủ thiết kế và tính năng của xe.`;
    ...
    uploadForm?.addEventListener('submit', function(e) {
        ...
        // Upload images
        fetch(`/admin/carvariants/<?php echo e($carvariant->id); ?>/images`, {
            method: 'POST',
            body: formData,
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
...
function updateImagesTabCounter() {
    ...
    imageForm?.addEventListener('submit', function(e) {
        ...
        // Update image
        fetch(`/admin/carvariants/<?php echo e($carvariant->id); ?>/images/${imageId}`, {
            method: 'POST',
            body: formData,
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\forev\showroom-car-modern\resources\views/admin/carvariants/edit.blade.php ENDPATH**/ ?>
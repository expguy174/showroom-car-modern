    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 hover:shadow-md transition-shadow">
        <div class="flex items-center justify-between mb-4">
            <div class="flex-1">
                ...
                <p class="text-3xl font-bold text-gray-900 mb-2">{{ format_currency_short($monthlyRevenue ?? 0) }}</p>
                ...
                <div class="space-y-1">
                    <div class="flex justify-between text-xs">
                        ...
                        @endphp
                        <span class="font-medium">{{ format_currency_short($weeklyRevenue) }}</span>
                    </div>
                    <div class="flex justify-between text-xs">
                        ...
                        @endphp
                        <span class="font-medium">{{ format_currency_short($dailyRevenue) }}</span>
                    </div>
                </div>

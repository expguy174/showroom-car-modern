        ...
        <div class="flex items-center justify-between">
            <div>
                <div class="flex items-center space-x-3">
                    ...
                    @if($service->code)
                        <span class="text-sm text-gray-500 font-mono bg-gray-100 px-2 py-1 rounded">{{ $service->code }}</span>
                    @endif
                </div>
            ...
            <div class="flex items-center space-x-3">
                <a href="{{ route('admin.services.edit', $service) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="prose max-w-none">
                    <p class="text-gray-700 whitespace-pre-line">{{ $service->notes }}</p>
                </div>
            </div>
            @endif

            {{-- Service Appointments Statistics --}}
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">
                    ...
                    <div class="bg-blue-50 rounded-lg p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-blue-900">{{ $service->service_appointments_count ?? 0 }}</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-green-900">
                                    {{ $service->serviceAppointments()->where('status', 'completed')->count() }}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-yellow-900">
                                    {{ $service->serviceAppointments()->whereIn('status', ['scheduled', 'confirmed', 'in_progress'])->count() }}
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <dl class="space-y-3">
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900 font-mono bg-gray-50 px-2 py-1 rounded">{{ $service->code }}</dd>
                    </div>
                    ...
                    <div>
                        ...
                        <dd class="mt-1">
                            @if($service->price)
                                <span class="text-lg font-bold text-blue-600">{{ number_format($service->price, 0, ',', '.') }}đ</span>
                            @else
                    ...
                    <div>
                        ...
                        <dd class="mt-1">
                            @if($service->duration_minutes)
                                <span class="text-sm text-gray-900 font-medium">{{ $service->duration_minutes }} phút</span>
                            @else

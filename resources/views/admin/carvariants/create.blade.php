...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 max-w-4xl mx-auto">
    ...
    <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Tạo phiên bản xe mới cho mẫu xe</p>
            </div>
    ...
    {{-- Form --}}
    <form action="{{ route('admin.carvariants.store') }}" method="POST" class="p-6">
        @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" 
                                   ...
                                   value="{{ old('name') }}" required placeholder="Ví dụ: 2.0 CVT, 1.5 Turbo...">
                            @error('name')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4" 
                                      ...
                                      placeholder="Mô tả về phiên bản xe...">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="features" id="features" rows="3" 
                                      ...
                                      placeholder="Các tính năng nổi bật của phiên bản...">{{ old('features') }}</textarea>
                            @error('features')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>

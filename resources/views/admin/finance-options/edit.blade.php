...
@section('title', 'Chỉnh sửa gói trả góp')
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 max-w-7xl mx-auto">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-xl font-semibold text-gray-900">
                    ...
                    Chỉnh sửa gói trả góp
                </h1>
                <p class="text-sm text-gray-600 mt-1">Cập nhật thông tin gói vay cho khách hàng</p>
            </div>
    ...
    {{-- Form --}}
    <form id="financeForm" action="{{ route('admin.finance-options.update', $financeOption) }}" method="POST" class="p-6" novalidate>
        @csrf
        @method('PUT')
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name" id="name"
                                   ...
                                   value="{{ old('name', $financeOption->name) }}" placeholder="VD: Gói vay ưu đãi 0%">
                            @error('name')
                        ...
                        <div>
                            ...
                            <input type="text" name="code" id="code"
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                   value="{{ old('code', $financeOption->code) }}" placeholder="VD: VP-001">
                            @error('code')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="bank_name" id="bank_name"
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                   value="{{ old('bank_name', $financeOption->bank_name) }}" placeholder="VD: Vietcombank, Techcombank...">
                            @error('bank_name')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4" 
                                      class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                      placeholder="Mô tả chi tiết về gói vay...">{{ old('description', $financeOption->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="min_tenure" id="min_tenure"
                                       class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                       value="{{ old('min_tenure', $financeOption->min_tenure) }}">
                                @error('min_tenure')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="max_tenure" id="max_tenure"
                                       class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                       value="{{ old('max_tenure', $financeOption->max_tenure) }}">
                                @error('max_tenure')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="min_down_payment" id="min_down_payment"
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                   value="{{ old('min_down_payment', $financeOption->min_down_payment) }}">
                        ...
                        <div>
                            ...
                            <textarea name="requirements" id="requirements" rows="3" 
                                      class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                      placeholder="VD: CMND/CCCD, Hộ khẩu, Sổ hộ khẩu...">{{ old('requirements', $financeOption->requirements) }}</textarea>
                            @error('requirements')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="number" step="0.01" name="interest_rate" id="interest_rate"
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                   value="{{ old('interest_rate', $financeOption->interest_rate) }}">
                            @error('interest_rate')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="processing_fee" id="processing_fee"
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                   value="{{ old('processing_fee', $financeOption->processing_fee) }}">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="number" name="min_loan_amount" id="min_loan_amount"
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                   value="{{ old('min_loan_amount', $financeOption->min_loan_amount) }}">
                        ...
                        <div>
                            ...
                            <input type="number" name="max_loan_amount" id="max_loan_amount"
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                   value="{{ old('max_loan_amount', $financeOption->max_loan_amount) }}">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="number" name="sort_order" id="sort_order" 
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                   value="{{ old('sort_order', $financeOption->sort_order) }}">
                            @error('sort_order')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="checkbox" name="is_active" id="is_active" value="1" 
                                   ...
                                   {{ old('is_active', $financeOption->is_active) ? 'checked' : '' }}>
...
document.getElementById('financeForm').addEventListener('submit', function(e) {
    ...
    .then(data => {
        if (data.success) {
            if (window.showMessage) {
                window.showMessage(data.message || 'Cập nhật gói vay thành công!', 'success');
            }
    ...
    .catch(error => {
        ...
        if (error.status === 422 && error.data && error.data.errors) {
            ...
            if (window.showMessage) {
                window.showMessage(error.message || 'Có lỗi xảy ra khi cập nhật gói vay', 'error');
            }
        }

...
@section('title', 'Chỉnh sửa showroom: ' . $showroom->name)
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 max-w-7xl mx-auto">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-xl font-semibold text-gray-900">
                    ...
                    Chỉnh sửa showroom: {{ $showroom->name }}
                </h1>
    ...
    {{-- Form --}}
    <form id="showroomForm" action="{{ route('admin.showrooms.update', $showroom) }}" method="POST" class="p-6">
        @csrf
        @method('PUT')
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4"
                                class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Nhập mô tả về showroom...">{{ old('description', $showroom->description) }}</textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            <label class="flex items-center">
                                ...
                                <input type="checkbox" name="is_active" value="1"
                                    ...
                                    {{ old('is_active', $showroom->is_active) ? 'checked' : '' }}>

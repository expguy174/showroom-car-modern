<x-guest-layout>
    ...
    <form x-data="{ show1: false, show2: false }" @submit="showButtonLoading($event.target.querySelector('button[type=submit]'), 'Đang tạo tài khoản...')" method="POST" action="{{ route('register') }}" class="space-y-5">
        @csrf
        ...
        <!-- Phone (nullable) -->
        <div>
            <label for="phone" class="block text-sm font-medium text-gray-700">Số điện thoại (không bắt buộc)</label>
            <div class="mt-1 relative">
        ...
        <div>
            ...
            <div class="mt-1 relative">
                <input :type="show1 ? 'text' : 'password'" id="password" name="password" required autocomplete="new-password" placeholder="••••••••"
        ...
        <div class="flex items-start gap-3">
            <input id="terms" type="checkbox" required class="mt-1 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
